...
public class WorkloadModel implements Serializable {
	 ...
	 * @param name
	 */
	public WorkloadModel(String workloadId,String state,String subState,String type,String workloadText,String workloadDetails) {
		super();
	...
	/**
	 * @param value the workload Id to set
	 */
	...
	/**
	 * @param name the subState to set
	 */
	...
	/**
	 * @param value the workloadText to set
	 */
	...
	/**
	 * @param value the workload details to set
	 */
