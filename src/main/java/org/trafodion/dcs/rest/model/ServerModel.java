...
public class ServerModel implements Serializable {
	 ...
	 * @param data
	 */
	public ServerModel(String type,String znode,String data) {
		super();
		this.type = type;
		this.znode = znode;
		this.data = data;
//		this.timestamp = DateFormat.getDateTimeInstance().format(new Date(new Long(ts)));
		
//		this.endTimestamp = DateFormat.getDateTimeInstance().format(new Date(workload.getEndTimestamp()));
//		this.duration = String.format("%1$tH%2$s%1$tM%2$s%1$tS",workload.getDuration(),":");
	}
