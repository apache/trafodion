...
public class TrxTableClient4 {
  ...
  private static final String TABLE_NAME = "table4";
 ...
 try {
  ...
  static public void main(String[] args) {
    ...
    System.out.println("Starting TrxTableClient4");
    ...
    try {
      ...
      System.out.println("TrxTableClient4 threw IOException");
      System.out.println(e.toString());
    } catch (Throwable t) {
      System.out.println("TrxTableClient4 threw throwable exception");
      System.out.println(t.toString());
    }

    System.out.println("Finished TrxTableClient4");
  }
