...
public:
    ...
    enum MemLogEvents
    {
        ...
        MON_NSCONNTONEWMON_3,
        MON_NSCONNTONEWMON_4,
        MON_NSCONNTONEWMON_5,
        MON_NSCONNTONEWMON_6,
        MON_NSCONNTONEWMON_7,
        MON_NSCONNTONEWMON_8,
        MON_NSCONNTONEWMON_9,
        MON_NSCONNTONEWMON_10,
        MON_NSCONNTONEWMON_11,
        MON_NSCONNTONEWMON_12,
    };
