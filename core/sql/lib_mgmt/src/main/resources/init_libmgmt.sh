...
function createProcedures {
    ...
    ${CI} << procEOF
      ...
      CREATE PROCEDURE GETSTARTWITH (
      IN SQLSTMT VARCHAR(1024) CHARACTER SET UTF8, 
      IN STARTWITHKEY VARCHAR(256) CHARACTER SET UTF8,  
      OUT CHILDNAMES VARCHAR(12800) CHARACTER SET UTF8)
      EXTERNAL NAME 'org.trafodion.libmgmt.FileMgmt.getStartWith (java.lang.String,java.lang.String,java.lang.String[])'
      EXTERNAL SECURITY DEFINER
      LIBRARY ${LIB_NAME}
      LANGUAGE JAVA
      PARAMETER STYLE JAVA 
      ...
      CREATE PROCEDURE CONNECTBY (
      IN COLUMNNAME VARCHAR(256) CHARACTER SET UTF8,
      IN ORIGINSQLSTMT VARCHAR(1024) CHARACTER SET UTF8,
      IN STARTWITHSQLSTMT VARCHAR(1024) CHARACTER SET UTF8, 
      IN STARTWITHKEY VARCHAR(256) CHARACTER SET UTF8) 
