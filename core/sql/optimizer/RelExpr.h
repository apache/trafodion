...
public:
 ...
 public:
  ...
  ItemExpr * startWithPredTree() const                  { return startWith_; }
  const ItemExpr * getStartWithPredTree() const               { return startWith_; }

  ItemExpr * connectByPredTree() const                        { return connectBy_; }
  const ItemExpr * getConnectByPredTree() const               { return connectBy_; }

  ValueIdSet & getStartWith()            { return startPred_; }
  ValueIdSet & getConnectBy()            { return connectByPred_; }
...
private:
  ...
  ItemExpr             * startWith_ ;
  ValueIdSet           startPred_;

  ItemExpr             * connectBy_;
  ValueIdSet           connectByPred_;
