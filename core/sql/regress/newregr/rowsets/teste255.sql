...
EXEC SQL MODULE CAT.SCH.TESTE255M NAMES ARE ISO88591;
...
for (i=0; i<SIZE; i++) {
  ...
  EXEC SQL
  INSERT INTO nt1set VALUES (:a_int, cast( '05.01.1997 03.04.55.123456' as timestamp),'how are ' || :b_char6) NOT ATOMIC ;
...
for (i=0; i<SIZE; i++) {
  ...
  EXEC SQL
  INSERT INTO nt1set VALUES (:a_int :a_ind, cast( '05.01.1997 03.04.55.123456' as timestamp),'how are ' || :b_char5)  NOT ATOMIC  ;
...
for (i=0; i<SIZE; i++) {
  ...
  EXEC SQL
  INSERT INTO nt1set VALUES (case when :name_char like :pattern_char escape :escape_char then :a_int else :b_int end, cast( '05.01.1997 03.04.55.123456' as timestamp),'how are you?') NOT ATOMIC;
...
for (i=0; i<SIZE; i++) {
  ...
  EXEC SQL
  INSERT INTO nt1set VALUES (case when :name_char like :pattern_char escape '$' then :a_int else :b_int end, cast( '05.01.1997 03.04.55.123456' as timestamp),'how are you?') NOT ATOMIC;
...
test15()
{
  ...
  // grant priviledges 
  EXEC SQL
    GRANT ALL PRIVILEGES ON TABLE nt1set TO "sql.user1";
  ...
  {
    EXEC SQL
      INSERT INTO nt1set VALUES (:a_int,
    ...
    {
      EXEC SQL
	REVOKE ALL PRIVILEGES ON TABLE nt1set FROM "sql.user1";      
    }      
