...
EXEC SQL MODULE delete1 NAMES ARE ISO88591 ; 
...
int main(int argc, char* argv[])
{
	...
	int  expectedRes[NUM_ROWS_RESULT][2] = {{1, 11}, {2,12}, { 3,13}};
	printDebug("\n\n--------------- start ------------------------");
	...
	EXEC SQL DECLARE curs1 CURSOR FOR
		SELECT a, b FROM cat1.schm.tab1A where a<4
		for update;
	...
	while(strcmp(SQLSTATE, SQLSTATE_OK)== 0 ){
		EXEC SQL DELETE FROM cat1.schm.tab1A
