...
CRURcReleaseTask::CRURcReleaseTask(Lng32 id, CRUObject &obj) :
	inherited(id), 
	obj_(obj)
{}
...
CRUTaskExecutor * CRURcReleaseTask::CreateExecutorInstance() 
{
	return new CRURcReleaseTaskExecutor(this);
}
