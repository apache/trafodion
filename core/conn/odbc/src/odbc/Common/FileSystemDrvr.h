...
public:
	...
	bool		DoWriteRead(HEADER*& hdr, char*& buffer, unsigned short& count, long timeout);

	inline	short GetFileNum() { return m_filenum; }
	inline	char* GetProcessName() { return m_process_name; }
	void		cleanup(void);
...
private:
	...
	friend class CFSystemDrvr_list;
};
