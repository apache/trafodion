 ...
 *
 * You register a notification routine for a file descriptor’s availability
 ...
 *
 * <obj_tag>        An arbitrary value that will be passed to this object’s methods
 ...
 * !CEE_NSK_TFILE_OPEN
 * 
 * "CEE_NSK_TFILE_OPEN" opens the Transaction Monitoring Facility’s (TMF) TFILE, which
 * is known as $TMP.
 *
 ...
 *
 * <obj_tag>                    An arbitrary value. This value is passed to this object’s
 *                              methods. This provides a mechanism to pass context
 *                              information to an object’s methods. 
 *                              
 * <impl_handle>                The implementation handle. Use "CEE_IMPLEMENTATION_CREATE"
 *                              to obtain this value. This handle defines the object’s
 ...
 * for a given operation, or if an operation’s method is set to NULL, CEE generates a
