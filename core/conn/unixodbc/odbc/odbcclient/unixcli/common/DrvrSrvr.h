...
#define MAX_CURSOR_NAME_LEN			128
#define MAX_STMT_NAME_LEN			128
...
#define TYPE_CONFIG					0x000002000L // added for CONFIG support from scripts
...
#define	SQLDTCODE_YEAR_TO_DAY			1 //SQL/MX DATE
