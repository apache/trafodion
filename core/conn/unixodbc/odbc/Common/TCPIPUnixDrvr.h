...
extern 
bool DoIO (CTCPIPUnixDrvr* pTCPIPSystem, char* wbuffer, long write_count, char*& rbuffer, long& read_count);
extern 
bool OpenIO (CTCPIPUnixDrvr* pTCPIPSystem, char* object_ref);
extern 
void CloseIO (CTCPIPUnixDrvr* pTCPIPSystem);
extern
void DoCompression(CTCPIPUnixDrvr* pTCPIPSystem, HEADER& wheader, unsigned char* wbuffer, unsigned long& write_count);
extern
bool DoExpand(CTCPIPUnixDrvr* pTCPIPSystem, HEADER& rheader, unsigned char* rbuffer, unsigned long& read_count);
