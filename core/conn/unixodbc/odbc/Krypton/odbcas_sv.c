 ...
 */
static void
odbcas_ASSvc_ClearTestPoint_smw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbcas_ASSvc_ClearTestPoint_smt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbcas_ASSvc_DataSourceConfigChanged_amw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbcas_ASSvc_DataSourceConfigChanged_amt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbcas_ASSvc_DataSourceConfigChanged_smw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbcas_ASSvc_DataSourceConfigChanged_smt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbcas_ASSvc_GeneralParam_amw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbcas_ASSvc_GeneralParam_amt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbcas_ASSvc_GeneralParam_smw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbcas_ASSvc_GeneralParam_smt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbcas_ASSvc_EnableTrace_amw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbcas_ASSvc_EnableTrace_amt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbcas_ASSvc_EnableTrace_smw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbcas_ASSvc_EnableTrace_smt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbcas_ASSvc_DisableTrace_amw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbcas_ASSvc_DisableTrace_amt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbcas_ASSvc_DisableTrace_smw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbcas_ASSvc_DisableTrace_smt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbcas_ASSvc_GetVersionAS_amw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbcas_ASSvc_GetVersionAS_amt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbcas_ASSvc_GetVersionAS_smw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbcas_ASSvc_GetVersionAS_smt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
  ...
  /* In  */ ...)
{
  ...
  if ((sts = CEE_SET_METHOD(&impl, 1, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_RegProcess_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 2, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_GetObjRefHdl_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 3, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_UpdateSrvrState_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 4, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_SrvrMonitorCall_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 5, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_StartAS_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 6, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_StopAS_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 7, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_StartDS_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 8, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_StopDS_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 9, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_StatusAS_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 10, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_StatusDS_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 11, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_StatusDSDetail_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 12, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_StatusSrvrAll_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 13, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_StopSrvr_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 14, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_StatusDSAll_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 15, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_WouldLikeToLive_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 16, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_SetTestPoint_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 17, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_ClearTestPoint_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 18, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_DataSourceConfigChanged_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 19, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_GeneralParam_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 20, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_EnableTrace_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 21, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_DisableTrace_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 22, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbcas_ASSvc_GetVersionAS_amw_)) != CEE_SUCCESS)
    goto error_1;
  *implementation_handle = impl;
  CEE_INTERFACE_DESTROY(&intf);
  return CEE_SUCCESS;
