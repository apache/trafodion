...
class odbc_SQLSvc_ExtractLob_exc_ {
	int exception_nr;
	...
	//
	static final int odbc_SQLSvc_ExtractLob_ParamError_exn_ = 1;
	static final int odbc_SQLSvc_ExtractLob_InvalidConnection_exn_ = 2;
	static final int odbc_SQLSvc_ExtractLob_SQLError_exn_ = 3;
	static final int odbc_SQLSvc_ExtractLob_SQLInvalidHandle_exn_ = 4;

	odbc_SQLSvc_ExtractLob_exc_() {
	...
	void extractFromByteArray(LogicalByteArray buffer1, InterfaceConnection ic)
		...
		case odbc_SQLSvc_ExtractLob_ParamError_exn_:
			...
			throw TrafT4Messages.createSQLException(null, ic.getLocale(), "ids_program_error", ParamError, null);
