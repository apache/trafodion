...
----
java -classpath $REST_HOME/lib/jetty-6.1.26.jar:$REST_HOME/lib/jetty-util-6.1.26.jar org.mortbay.jetty.security.Password {password}
----
...
Copy/paste the entire string beginning including "OBF:" into this property.
...
----
java -classpath $REST_HOME/lib/jetty-6.1.26.jar:$REST_HOME/lib/jetty-util-6.1.26.jar org.mortbay.jetty.security.Password {obfuscated password string}
----
