...
ParKeyWord ParKeyWords::keyWords_[] = {
  ...
  ParKeyWord("CLEANUP",            TOK_CLEANUP,     NONRESTOKEN_),
  ...
  ParKeyWord("DOUBLE_TANDEM",      TOK_DOUBLE_TANDEM, NONRESTOKEN_),
  ...
  ParKeyWord("FLOAT_TANDEM",       TOK_FLOAT_TANDEM, NONRESTOKEN_),
  ...
  ParKeyWord("INTERPRET_AS_ROW",   TOK_INTERPRET_AS_ROW, NONRESTOKEN_),
  ...
  ParKeyWord("METADATA",       TOK_METADATA, NONRESTOKEN_),
  ...
  ParKeyWord("OSIM_CAPTURE",       TOK_OSIM_CAPTURE,NONRESTOKEN_),
...
// PATH is already used in CQS ...
  ...
  ParKeyWord("RECALIBRATE",        TOK_RECALIBRATE, NONRESTOKEN_),
  ...
  ParKeyWord("REORG",              TOK_REORG,       SECOND_|COMPAQ_|RESWORD_),
  ParKeyWord("REORGANIZE",         TOK_REORG,       COMPAQ_|RESWORD_),
  ...
  ParKeyWord("REPLICATE",          TOK_REPLICATE,   FIRST_|SECOND_|COMPAQ_|RESWORD_),
  ...
  ParKeyWord("RESOURCE_FORK",      TOK_RESOURCE_FORK, NONRESTOKEN_),
  ...
  ParKeyWord("SEQUENCE",           TOK_SEQUENCE,    FIRST_|NONRESTOKEN_),
  ...
  ParKeyWord("SIDEINSERTS",        TOK_SIDEINSERTS, NONRESTOKEN_),
  ...
  ParKeyWord("SQLMP",              TOK_SQLMP,       NONRESTOKEN_),
...
// used in QAT tests
  ...
  ParKeyWord("VALUE",              TOK_VALUE,       ANS_|RESWORD_),
