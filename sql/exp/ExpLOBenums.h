...
typedef enum {
  ...
  LOB_SEND_MSG_ERROR,
  LOB_OPER_REQ_IN_PROGRESS,
  LOB_OPER_REQ_DONE,
  LOB_SERVER_OPEN_ERROR = 540,
  ...
  LOB_DATA_FLUSH_ERROR = 547,
  LOB_HDFS_CONNECT_ERROR,
