...
enum CatErrorCode { CAT_FIRST_ERROR = 1000
                  ...
                  , CAT_BAD_SCHEMA_AUTHORIZATION_ID               = 1023
                  , CAT_FS_ERROR                                  = 1024
                  ...
                  , CAT_UNABLE_TO_INITIALIZE_SQL                  = 1034
                  , CAT_CATALOG_ALREADY_EXISTS                    = 1035
                  , CAT_ONLY_SUPER_ID_CAN_DROP_SQL                = 1036
                  , CAT_NO_SQL_ON_SYSTEM                          = 1037
                  , CAT_CATALOGS_ARE_STILL_ON_THE_SYSTEM          = 1038
                  , CAT_UNABLE_TO_DROP_SQL                        = 1039
                  ...
                  , CAT_USER_CANNOT_DROP_SMD_INDEX                = 1063
                  , CAT_USER_CANNOT_DROP_SMD_VIEW                 = 1064
                  , CAT_CREATE_CONSTRAINT_NOT_ALLOWED_IN_SMD      = 1065
                  , CAT_CREATE_INDEX_NOT_ALLOWED_IN_SMD           = 1066
                  , CAT_CREATE_MODULE_NOT_ALLOWED_IN_SMD          = 1067
                  , CAT_CREATE_LOCK_NOT_ALLOWED_IN_SMD            = 1068
                  ...
                  , CAT_VIEW_NOT_IN_METADATA_TABLE                = 1077
                  , CAT_ILLEGAL_LOCATION_FORMAT                   = 1078
                  , CAT_ERRORS_ENCOUNTERED_IN_BINDING_PHASE       = 1079
                  ...
                  , CAT_KEY_LENGTH_INCORRECT                      = 1085
                  , CAT_LOCK_DOES_NOT_EXIST_ERROR                 = 1086
                  , CAT_CONFLICTING_LOCK_EXISTS                   = 1087
                  , CAT_WRONG_KEY_ORDER                           = 1088
                  , CAT_SYSKEY_NOT_LAST_COLUMN                    = 1089
                  , CAT_SELF_REFERENCING_CONSTRAINT               = 1090
                  , CAT_CONSTRAINT_OR_OPTION_NOT_PERMITTED_ON_VP_TABLE
                  , CAT_COLUMN_MUST_BE_ASSIGNED_TO_VP             = 1092
                  , CAT_CANNOT_ASSIGN_SYSTEM_COLUMN_TO_VP         = 1093
                  , CAT_WRONG_OBJECT_TYPE                         = 1094
                  , CAT_BAD_PARTITION_BY_COLUMNS                  = 1095
                  , CAT_CLI_VALIDATE_OBJECT                       = 1096
                  ...
                  , CAT_SYSKEY_COL_NOT_ALLOWED_IN_UNIQUE_CNSTRNT  = 1147
                  , CAT_SYSKEY_COL_NOT_ALLOWED_IN_RI_CNSTRNT      = 1148
