...
//  schema owner.
  ...
  DDkwd__(COMP_BOOL_184,      "OFF"), // internal usage: convert count(*) to fast delete
...
SDDkwd__(EXE_DIAGNOSTIC_EVENTS,		"OFF"),
 ...
 // is ON for static compiles and OFF for dynamic queries.
  ...
  DDui1__(GEN_DDL_BUFFER_SIZE,			"1024"),
  DDui1__(GEN_DDL_NUM_BUFFERS,			"1"),
  DDui1__(GEN_DDL_SIZE_DOWN,			"2"),
  DDui1__(GEN_DDL_SIZE_UP,			"4"),
 ...
 DDkwd__(HBASE_RANGE_PARTITIONING_MC_SPLIT,	"ON"),
  ...
  DDkwd__(HBASE_SCAN_CACHE_BLOCKS,		"ON"),
  DDui1__(HBASE_SCAN_NUM_CACHE_ROWS,		"100"),
...
SDDkwd__(ISO_MAPPING,           (char *)SQLCHARSETSTRING_ISO88591),
 ...
 XDDkwd__(NESTED_JOINS,				"ON"),
  ...
  DDkwd__(NESTED_JOINS_KEYLESS_INNERJOINS,     "OFF"),
