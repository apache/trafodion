...
typedef Int32 (PTRCALL *SCANNER)(const ENCODING *,
                               const char *,
                               const char *,
                               const char **);
...
struct encoding {
  ...
  Int32 (PTRCALL *sameName)(const ENCODING *,
                          const char *,
                          const char *);
  Int32 (PTRCALL *nameMatchesAscii)(const ENCODING *,
                                  const char *,
                                  const char *,
                                  const char *);
  Int32 (PTRFASTCALL *nameLength)(const ENCODING *, const char *);
  const char *(PTRFASTCALL *skipS)(const ENCODING *, const char *);
  Int32 (PTRCALL *getAtts)(const ENCODING *enc,
                         const char *ptr,
                         Int32 attsMax,
                         ATTRIBUTE *atts);
  Int32 (PTRFASTCALL *charRefNumber)(const ENCODING *enc, const char *ptr);
  Int32 (PTRCALL *predefinedEntityName)(const ENCODING *,
                                      const char *,
                                      const char *);
  void (PTRCALL *updatePosition)(const ENCODING *,
                                 ...
                                 const char *end,
                                 POSITION *);
  Int32 (PTRCALL *isPublicId)(const ENCODING *enc,
                            const char *ptr,
                            const char *end,
                            const char **badPtr);
...
Int32 XmlParseXmlDecl(Int32 isGeneralTextEntity,
                    const ENCODING *enc,
                    const char *ptr,
                    const char *end,
                    const char **badPtr,
...
Int32 XmlParseXmlDeclNS(Int32 isGeneralTextEntity,
                      const ENCODING *enc,
                      const char *ptr,
                      const char *end,
                      const char **badPtr,
