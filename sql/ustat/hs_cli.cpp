...
Lng32 CreateSeabaseHist(const HSGlobalsClass* hsGlobal)
  {
    ...
    ddl.append(hsGlobal->hstogram_table->data())
       .append(" (  TABLE_UID      LARGEINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , HISTOGRAM_ID   INT UNSIGNED NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , COL_POSITION   INT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , COLUMN_NUMBER  INT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , COLCOUNT       INT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , INTERVAL_COUNT SMALLINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , ROWCOUNT       LARGEINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , TOTAL_UEC      LARGEINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , STATS_TIME     TIMESTAMP(0) NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , LOW_VALUE      VARCHAR(250) CHARACTER SET UCS2 COLLATE DEFAULT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , HIGH_VALUE     VARCHAR(250) CHARACTER SET UCS2 COLLATE DEFAULT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , READ_TIME      TIMESTAMP(0) NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , READ_COUNT     SMALLINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , SAMPLE_SECS    LARGEINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , COL_SECS       LARGEINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , SAMPLE_PERCENT SMALLINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , CV             FLOAT(54) NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , REASON         CHAR(1) CHARACTER SET ISO88591 COLLATE DEFAULT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , V1             LARGEINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , V2             LARGEINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , V3             LARGEINT NO DEFAULT NOT NULL NOT DROPPABLE"
...
Lng32 CreateSeabaseHistint(const HSGlobalsClass* hsGlobal)
  {
    ...
    ddl.append(hsGlobal->hsintval_table->data())
       .append(" (  TABLE_UID         LARGEINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , HISTOGRAM_ID      INT UNSIGNED NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , INTERVAL_NUMBER   SMALLINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , INTERVAL_ROWCOUNT LARGEINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , INTERVAL_UEC      LARGEINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , INTERVAL_BOUNDARY VARCHAR(250) CHARACTER SET UCS2 COLLATE DEFAULT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , STD_DEV_OF_FREQ   NUMERIC(12, 3) NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , V1                LARGEINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , V2                LARGEINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , V3                LARGEINT NO DEFAULT NOT NULL NOT DROPPABLE"
               "  , V4                LARGEINT NO DEFAULT NOT NULL NOT DROPPABLE"
