...
class ExExeLoadUtilTcb : public ExExeUtilTcb
{
 public:
  // Constructor
  ExExeLoadUtilTcb(const ComTdbExeUtil & exe_util_tdb,
                   ex_globals * glob = 0);
...
class ExExeLoadUtilPrivateState : public ex_tcb_private_state
{
  friend class ExExeLoadUtilTcb;

 public:
  ExExeLoadUtilPrivateState();
  ~ExExeLoadUtilPrivateState();        // destructor
 protected:
};
...
//////////////////////////////////////////////////////////////////////////
// -----------------------------------------------------------------------
// ExExeUtilGetReorgStatisticsTdb
// -----------------------------------------------------------------------
class ExExeUtilGetReorgStatisticsTdb : public ComTdbExeUtilGetReorgStatistics
{
public:
  ...
  // unpacking. An empty constructor is enough.
  // ---------------------------------------------------------------------
  NA_EIDPROC ExExeUtilGetReorgStatisticsTdb()
  {}

  NA_EIDPROC virtual ~ExExeUtilGetReorgStatisticsTdb()
  {}
...
// -----------------------------------------------------------------------
// ExExeUtilUserLoadTdb
// -----------------------------------------------------------------------
class ExExeUtilUserLoadTdb : public ComTdbExeUtilUserLoad
{
public:
  ...
  // unpacking. An empty constructor is enough.
  // ---------------------------------------------------------------------
  NA_EIDPROC ExExeUtilUserLoadTdb()
  {}

  NA_EIDPROC virtual ~ExExeUtilUserLoadTdb()
  {}
...
///////////////////////////////////////////////////////////////
// ExExeUtilUserLoadTcb
///////////////////////////////////////////////////////////////
class ExExeUtilUserLoadTcb : public ExExeUtilTcb
{
public:
  // Constructor
  ExExeUtilUserLoadTcb(const ComTdbExeUtilUserLoad & exe_util_tdb,
                       const ex_tcb * child_tcb, // for child queue
                       ex_globals * glob = 0);
...
protected:
  ExExeUtilUserLoadTdb & ulTdb() const
  {return (ExExeUtilUserLoadTdb &) tdb;};

  short checkForEOD();

  NABoolean isEOD() { return eod_; }

  NABoolean eod_;

  NABoolean firstReqSeen_;
};

class ExExeUtilUserLoadPrivateState : public ex_tcb_private_state
{
  friend class ExExeUtilUserLoadTcb;
  friend class ExExeUtilUserLoadFastTcb;

public:
  ExExeUtilUserLoadPrivateState();
  ~ExExeUtilUserLoadPrivateState();        // destructor
protected:
};

// -----------------------------------------------------------------------
// ExExeUtilSidetreeInsertTdb
// -----------------------------------------------------------------------
class ExExeUtilSidetreeInsertTdb : public ComTdbExeUtilSidetreeInsert
{
public:
  ...
  // unpacking. An empty constructor is enough.
  // ---------------------------------------------------------------------
  NA_EIDPROC ExExeUtilSidetreeInsertTdb()
  {}

  NA_EIDPROC virtual ~ExExeUtilSidetreeInsertTdb()
  {}
...
///////////////////////////////////////////////////////////////
// ExExeUtilSidetreeInsertTcb
///////////////////////////////////////////////////////////////
class ExExeUtilSidetreeInsertTcb : public ExExeUtilTcb
{
public:
  // Constructor
  ExExeUtilSidetreeInsertTcb(const ComTdbExeUtilSidetreeInsert & exe_util_tdb,
			     const ex_tcb * child_tcb, // for child queue
			     ex_globals * glob = 0);
...
protected:
  enum Step
  {
    ...
    EMPTY_TABLE_CHECK_,
    NO_ROLLBACK_INSERT_,
    NO_ROLLBACK_INSERT_THROUGH_AQR_,
    SIDETREE_INSERT_,
    ALTER_TO_NOAUDIT_,
    ALTER_TO_AUDIT_,
    SEND_REQ_TO_CHILD_,
    ...
    ERROR_FROM_CHILD_,
    ROLLBACK_XN_,
    ALTER_TO_AUDIT_AND_ERROR_,
    PURGEDATA_TGT_AND_ERROR_,
    COMMIT_XN_,
    ERROR_,
    CANCEL_,
    DONE_
  ...
  NABoolean ddlLockWasAdded_;

  ExExeUtilSidetreeInsertTdb & ulTdb() const
  {return (ExExeUtilSidetreeInsertTdb &) tdb;};

  void setStep(Step newStep, int lineNum);
};

class ExExeUtilSidetreeInsertPrivateState : public ex_tcb_private_state
{
  friend class ExExeUtilSidetreeInsertTcb;

public:
  ExExeUtilSidetreeInsertPrivateState();
  ~ExExeUtilSidetreeInsertPrivateState();        // destructor
protected:
};

///////////////////////////////////////////////////////////////
// ExExeUtilSidetreeInsertAlterAuditTcb
///////////////////////////////////////////////////////////////
class ExExeUtilSidetreeInsertAlterAuditTcb : public ExExeUtilSidetreeInsertTcb
{
public:
  // Constructor
  ExExeUtilSidetreeInsertAlterAuditTcb(const ComTdbExeUtilSidetreeInsert & exe_util_tdb,
				       const ex_tcb * child_tcb, // for child queue
				       ex_globals * glob = 0);
...
///////////////////////////////////////////////////////////////
// ExExeUtilUserLoadFastTcb
///////////////////////////////////////////////////////////////

const UInt32 NumTraces = 16;

class ExExeUtilUserLoadFastTcb : public ExExeUtilUserLoadTcb
{
public:
  // Constructor
  ExExeUtilUserLoadFastTcb(const ComTdbExeUtilUserLoad & exe_util_tdb,
                           const ex_tcb * child_tcb, // for child queue
                           ex_globals * glob = 0);
...
private:
  ...
  {
    INITIAL_,
    INITIALIZE_NAR_EXCEPTION_,
    HANDLE_NAR_EXCEPTION_,
    END_NAR_EXCEPTION_,
    GET_INPUT_VALUES_,
    SEND_REQ_TO_CHILD_,
    GET_REPLY_FROM_CHILD_,
    SEND_EOD_TO_CHILD_,
    SEND_EOD_NO_ST_COMMIT_TO_CHILD_,
    CANCEL_CHILD_,
    CANCEL_CHILD_AND_ERROR_,
    ERROR_,
    ERROR_DONE_,
    DONE_,
    TRACE_NEVER_TRACED
  ...
  struct StepTraceEntry {
    Step oldStep_;
    Int32 changedOnLine_;    // this is the line that changed oldStep_.
    queue_index childDownTail_;
    queue_index childDownHead_;
    queue_index childUpTail_;
    queue_index childUpHead_;
    Lng32 currentRowNum_;
    Int64 numRqstsToChild_;
  };

  // helps with debugging loops
  StepTraceEntry  stepTrace_[NumTraces];
  UInt32 lastStep_;

  void changeAndTraceStep(Step s, Int32 l);
  ...
  NABoolean narExcepInitialized_;
...
// -----------------------------------------------------------------------
// ExExeUtilHBaseBulkUnLoadTaskTdb
// -----------------------------------------------------------------------
class ExExeUtilHBaseBulkUnLoadTaskTdb : public ComTdbExeUtilHBaseBulkUnLoadTask
{
 public:
  ...
  // unpacking. An empty constructor is enough.
  // ---------------------------------------------------------------------
  NA_EIDPROC ExExeUtilHBaseBulkUnLoadTaskTdb()
    {}

  NA_EIDPROC virtual ~ExExeUtilHBaseBulkUnLoadTaskTdb()
    {}
...
class ExExeUtilHBaseBulkUnLoadTaskTcb : public ExExeUtilTcb
{
 public:

  // Constructor
  ExExeUtilHBaseBulkUnLoadTaskTcb(const ComTdbExeUtilHBaseBulkUnLoadTask & exe_util_tdb,
                         ex_globals * glob = 0);

  ~ExExeUtilHBaseBulkUnLoadTaskTcb();
...
//
 ...
 private:
  ...
  ExExeUtilHBaseBulkUnLoadTaskTdb & ulTdb() const
    {return (ExExeUtilHBaseBulkUnLoadTaskTdb &) tdb;};
...
class ExExeUtilHBaseBulkUnLoadTaskPrivateState : public ex_tcb_private_state
{
  friend class ExExeUtilHBaseBulkUnLoadTaskTcb;

 public:
  ExExeUtilHBaseBulkUnLoadTaskPrivateState();
  ~ExExeUtilHBaseBulkUnLoadTaskPrivateState();        // destructor
 protected:
};
