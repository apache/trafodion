...
import org.trafodion.dcs.http.HttpServer;
 ...
 *   "/" -> the jsp server code from (src/dcs-webapps/<name>)
 */
public class InfoServer extends HttpServer {
   ...
   * The jsp scripts are taken from src/dcs-webapps/<code>name<code>.
  ...
  /**
   * Fixup where the logs app points, make it point at dcs logs rather than
   * hadoop logs.
   */
  private void fixupLogsServletLocation() {
    ...
    // Now do my logs.
    // Set up the context for "/logs/" if "dcs.log.dir" property is defined.
    String logDir = System.getProperty("dcs.log.dir");
    if (logDir != null) {
  ...
  protected String getWebAppsPath(String appName) throws FileNotFoundException {
    ...
    String resourceName = "dcs-webapps/" + appName;
  ...
  protected String getWebAppsPath() throws IOException {
    ...
    // get us the dcs context.  Presumption is that place where the
