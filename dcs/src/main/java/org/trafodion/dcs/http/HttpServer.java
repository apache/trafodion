...
package org.trafodion.dcs.http;
...
//import org.trafodion.dcs.security.authorize.AccessControlList;
...
public class HttpServer implements FilterContainer {
  ...
  // gets stored.
  public static final String CONF_CONTEXT_ATTRIBUTE = "dcs.conf";
...
//     addServlet("conf", "/conf", ConfServlet.class);
  ...
  protected String getWebAppsPath() throws IOException {
    URL url = getClass().getClassLoader().getResource("dcs-webapps");
    if (url == null) 
