...
[[dcs_default_configurations]]
=== DCS Default Configuration

The documentation below is generated using the default dcs configuration file, _dcs-default.xml_, as source.
