...
namespace log4cpp {
    ...
    Appender* PropertyConfiguratorImpl::instantiateAppender(const std::string& appenderName) {
        ...
        if (appenderType == "ConsoleAppender") {
            ...
            std::string fileName = _logsFolder + _properties.getString(appenderPrefix + ".fileName", "foobar") + _fileSuffix;
            ...
            bool append = _properties.getBool(appenderPrefix + ".append", true);
            mode_t mode = _properties.getInt(appenderPrefix + ".mode", 00644);
            bool addPid = _properties.getBool(appenderPrefix + ".addPid", false);
