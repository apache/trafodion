 ...
 * to standard output.
 */
public class PostExecute implements ExecuteWithHookContext {
  ...
  public void run(HookContext hookContext) throws Exception {
    ...
    this.run(ss,inputs,outputs,linfo,ugi,hconf);
  }

  public void run(SessionState sess, Set<ReadEntity> inputs,
      Set<WriteEntity> outputs, LineageInfo linfo,
      UserGroupInformation ugi, HiveConf hconf) throws Exception {
	  ...
	  if (sess != null) {
		  ...
		  console.printError("POSTHOOK: queryId: " + sess.getQueryId());
		  console.printError("POSTHOOK: sessionId: " + sess.getSessionId());
		  //PreExecute.printWms(sess,hconf,console);
    }

	//PreExecute.printEntities(console, inputs, "POSTHOOK: Input: ");
    //PreExecute.printEntities(console, outputs, "POSTHOOK: Output: ");
