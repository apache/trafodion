...
public final class ScriptManager {
    ...
    private static final String DEFAULT_SCRIPT_NAME = "hp_default_service"
            + PYTHON_SUFFIX;
    ...
    private ScriptManager() {
        ...
        sb.append("\nThe following " + engines.size()
                + " scripting engine(s) were found");
        ...
        watcherWorker = new ScriptManagerWatcher("ScriptManagerWatcher",
                wmsHome + "/bin/scripts");
    }
        ...
        try {
            ...
            if (engine instanceof Compilable) {
                ...
                if (script == null) {
                    ...
                    try {
                        script = compilingEngine.compile(new FileReader(
                                "bin/scripts/" + scriptName));
                    } catch (Exception e) {
                ...
                try {
                    engine.eval(new FileReader("bin/scripts/" + scriptName),
                            bindings);
                } catch (Exception e) {
                    LOG.warn(e.getMessage());
                }
