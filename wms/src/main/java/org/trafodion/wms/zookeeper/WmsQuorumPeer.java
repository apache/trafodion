...
/**
 * WMS's version of ZooKeeper's QuorumPeer. When WMS is set to manage
 ...
 * zoo.cfg and inject variables from Wms's site.xml configuration in.
 */
public class WmsQuorumPeer {
  /**
   * Parse ZooKeeper configuration from WMS XML config and run a QuorumPeer.
   * @param args String[] of command line arguments. Not used.
   */
	private static final Log LOG = LogFactory.getLog(WmsQuorumPeer.class.getName());
	
	public WmsQuorumPeer() {
  ...
  public static void main(String[] args) {
	  WmsQuorumPeer qp = new WmsQuorumPeer();
  }
  ...
  static void writeMyID(Properties properties) throws IOException {
    ...
    String myAddress = Strings.domainNamePointerToHostName(DNS.getDefaultHost(
        conf.get("wms.zookeeper.dns.interface","default"),
        conf.get("wms.zookeeper.dns.nameserver","default")));
