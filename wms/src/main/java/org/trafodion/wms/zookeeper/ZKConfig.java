...
public class ZKConfig {
  ...
  public static Properties makeZKProps(Configuration conf) {
    ...
    ClassLoader cl = WmsQuorumPeer.class.getClassLoader();
    ...
    // Directly map all of the wms.zookeeper.property.KEY properties.
    ...
    int peerPort = conf.getInt("wms.zookeeper.peerport", 2888);
    int leaderPort = conf.getInt("wms.zookeeper.leaderport", 3888);
  ...
  public static String getZKQuorumServersString(Properties properties) {
    ...
    if (servers.isEmpty()) {
      LOG.fatal("No server.X lines found in conf/zoo.cfg. Wms must have a " +
