...
import org.trafodion.sql.SQLMXStatement;
...
public class TConnection implements java.sql.Connection {
	...
	public PreparedStatement cpqPrepareStatement(String moduleName,
		...
		if (connection_ instanceof org.trafodion.sql.SQLMXConnection) {
			stmt = ((org.trafodion.sql.SQLMXConnection) connection_)
	...
	public String getTraceId() {
		...
		setTraceId(org.trafodion.sql.T2Driver.traceText
				...
				+ "]:"
				+ className.substring(
						org.trafodion.sql.T2Driver.REMOVE_PKG_NAME, className
								.length()) + ".");
