...
//Venu changed stmtId from int to long for 64 bit
	...
	public String getTraceId() {
		setTraceId(org.trafodion.sql.T2Driver.traceText
				+ org.trafodion.sql.T2Driver.dateFormat.format(new java.util.Date()) 
				+ "]:[" + Thread.currentThread() + "]:["
				+ System.identityHashCode(this) +  "]:"
				+ this.getClass().getName().substring(org.trafodion.sql.T2Driver.REMOVE_PKG_NAME,this.getClass().getName().length()) 
				+ ".");
		return traceId_;
	}
