...
SQLCLI_LIB_FUNC long CliDebug_SetStmtAttr(SQLSTMT_ID *statement_id, long attrName,
										  ...
										  const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_SetStmtAttr",("statement_id=0x%08x,attrName=%s,numeric_value=%ld,string_value=%s",
			statement_id,
...
SQLCLI_LIB_FUNC long CliDebug_SetDescItem(SQLDESC_ID *sql_descriptor, long entry,
										  ...
										  const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_SetDescItem",("sql_descriptor=0x%08x, entry=%d, what_to_set=%s, numeric_value=%ld, string_value=%s",
		   sql_descriptor,
		   entry,
...
SQLCLI_LIB_FUNC long CliDebug_SETROWSETDESCPOINTERS(SQLDESC_ID * desc_id, long rowset_size, int *rowset_status_ptr,
													...
													const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_SETROWSETDESCPOINTERS",("desc_id=0x%08x, rowset_size=%ld, rowset_status_ptr=0x%08x, starting_entry=%ld, num_quadruple_fields=%ld, quad_fields=0x%08x",
			desc_id,
			rowset_size,
			rowset_status_ptr,
			starting_entry,
...
SQLCLI_LIB_FUNC long CliDebug_GetDescItems2(SQLDESC_ID * sql_descriptor,
											...
											const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_GetDescItems2",("sql_descriptor=0x%08x, no_of_desc_items=%d, desc_items=0x%08x",
			sql_descriptor,
			no_of_desc_items,
			desc_items),
		filename, line);
...
SQLCLI_LIB_FUNC long CliDebug_SetCursorName(SQLSTMT_ID * statement_id, SQLSTMT_ID * cursor_name,
											const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_SetCursorName",("statement_id=0x%08x, cursor_name=0x%08x)",
			statement_id,
			cursor_name),
		filename, line);
...
SQLCLI_LIB_FUNC long CliDebug_ExecFetch(SQLSTMT_ID * statement_id,
										...
										const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_ExecFetch",("statement_id=0x%08x, input_descriptor=0x%08x, num_ptr_pairs=%d",
			statement_id,
			input_descriptor,
			num_ptr_pairs),
		filename, line);
...
SQLCLI_LIB_FUNC long CliDebug_CloseStmt(SQLSTMT_ID *statement_id,
										const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_CloseStmt",("statement_id=0x%08x",
			statement_id),
		filename, line);
...
SQLCLI_LIB_FUNC long CliDebug_GetDiagnosticsCondInfo2(long what_to_get, long conditionNum,
													  ...
													  const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_GetDiagnosticsCondInfo2",("what_to_get=%s, conditionNum=%ld, numeric_value=0x%08x, string_value=0x%08x, max_string_len=%ld, len_of_item=0x%08x",
	...
	if (numeric_value)
		DEBUG_OUT_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,("numeric_value=%ld",*numeric_value),filename,line);
	if (max_string_len)
		DEBUG_OUT_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,("string_value=%s",string_value),filename,line);
...
SQLCLI_LIB_FUNC long CliDebug_SwitchContext(SQLCTX_HANDLE context_handle, SQLCTX_HANDLE * prev_context_handle,
										    const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_SwitchContext",("context_handle=%ld, prev_context_handle=0x%08x",
			context_handle,
			prev_context_handle),
		filename, line);
	...
	DEBUG_OUT_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,("prev_handle=%ld",prev_handle),
		filename,line);
	CLI_DEBUG_RETURN_SQL_LOC(rc,filename,line);
}
...
SQLCLI_LIB_FUNC long CliDebug_DeleteContext(SQLCTX_HANDLE contextHandle,
										    const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_DeleteContext",("contextHandle=%ld",
			contextHandle),
		filename, line);
...
SQLCLI_LIB_FUNC long CliDebug_CreateContext(SQLCTX_HANDLE *context_handle,
										    ...
										    const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_CreateContext",("context_handle=0x%08x, sqlAuthId=0x%08x, suppressAutoXactStart=%ld",
			context_handle,
			sqlAuthId,
	...
	DEBUG_OUT_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,("context_handle=%ld",*context_handle),
		filename,line);
	CLI_DEBUG_RETURN_SQL_LOC(rc,filename,line);
}
...
SQLCLI_LIB_FUNC long CliDebug_CurrentContext(SQLCTX_HANDLE *contextHandle,
						const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_CurrentContext",("contextHandle=0x%08x",
			contextHandle),
		filename, line);
...
SQLCLI_LIB_FUNC long CliDebug_ClearDiagnostics (SQLSTMT_ID *statement_id,
											    const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_ClearDiagnostics",("statement_id=0x%08x",
			statement_id),
		filename, line);
...
SQLCLI_LIB_FUNC long CliDebug_GetDiagnosticsStmtInfo2(SQLSTMT_ID *statement_id, long what_to_get, int *numeric_value, char *string_value,
													  ...
													  const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_GetDiagnosticsStmtInfo2",("statement_id=0x%08x, what_to_get=%s, numeric_value=0x%08x, string_value=0x%08x, max_string_len=%ld, len_of_item=%ld",
			statement_id,
			DebugSqlDiagCondStr(what_to_get),
			numeric_value,
			string_value,
...
SQLCLI_LIB_FUNC long CliDebug_DeallocDesc(SQLDESC_ID *desc_id,
										  const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_DeallocDesc",("desc_id=0x%08x",
			desc_id),
		filename, line);
...
SQLCLI_LIB_FUNC long CliDebug_DeallocStmt(SQLSTMT_ID *statement_id,
										  const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_DeallocStmt",("statement_id=0x%08x",
			statement_id),
		filename, line);
...
SQLCLI_LIB_FUNC long CliDebug_ExecDirect(SQLSTMT_ID *statement_id, SQLDESC_ID *sql_source,
										 ...
										 const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_ExecDirect",("statement_id=0x%08x, sql_source=0x%08x, input_descriptor=0x%08x, num_ptr_pairs=%ld",
			statement_id,
			sql_source,
			input_descriptor,
			num_ptr_pairs),
...
SQLCLI_LIB_FUNC long CliDebug_Exec(SQLSTMT_ID *statement_id, SQLDESC_ID *input_descriptor,long num_ptr_pairs,
								   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_Exec",("statement_id=0x%08x, input_descriptor=0x%08x, num_ptr_pairs=%ld",
			statement_id,
			input_descriptor,
			num_ptr_pairs),
		filename, line);
...
SQLCLI_LIB_FUNC long CliDebug_Prepare(SQLSTMT_ID *statement_id, SQLDESC_ID *sql_source,
									  const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_Prepare",("statement_id=0x%08x,sql_source=0x%08x",
			statement_id,
			sql_source),
		filename, line);
...
SQLCLI_LIB_FUNC long CliDebug_DescribeStmt(SQLSTMT_ID *statement_id,
										   ...
										   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_DescribeStmt",("statement_id=0x%08x,input_descriptor=0x%08x,output_descriptor=0x%08x",
			statement_id,
			input_descriptor,
			output_descriptor),
		filename, line);
...
SQLCLI_LIB_FUNC long CliDebug_GetDescEntryCount(SQLDESC_ID *sql_descriptor, int *num_entries,
												const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_GetDescEntryCount",("sql_descriptor=0x%08x, num_entries=0x%08x",
			sql_descriptor,
			num_entries),
		filename, line);
	...
	if (num_entries)
		DEBUG_OUT_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,("num_entries=%ld",*num_entries),filename,line);
	CLI_DEBUG_RETURN_SQL_LOC(rc,filename,line);
}
...
SQLCLI_LIB_FUNC long CliDebug_Fetch(SQLSTMT_ID *statement_id, SQLDESC_ID *output_descriptor, long num_ptr_pairs,
									const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_Fetch",("statement_id=0x%08x, output_descriptor=0x%08x, num_ptr_pairs=%ld",
			statement_id,
			output_descriptor,
			num_ptr_pairs),
		filename, line);
	...
	DEBUG_OUT_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,("statement_id=0x%08x, output_descriptor=0x%08x, num_ptr_pairs=%ld",
...
SQLCLI_LIB_FUNC long CliDebug_GetDescItem(SQLDESC_ID *sql_descriptor, long entry,
										  ...
										  const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_GetDescItem",("sql_descriptor=0x%08x, entry=%ld, what_to_get=%s, numeric_value=0x%08x, string_value=0x%08x, max_string_len=%ld, len_of_item=0x%08x, start_from_offset=%ld",
			sql_descriptor,
			entry,
...
SQLCLI_LIB_FUNC long CliDebug_Cancel(SQLSTMT_ID *statement_id,
									 const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_Cancel",("statement_id=0x%08x",
			statement_id),
		filename, line);
...
SQLCLI_LIB_FUNC long CliDebug_AllocStmt(SQLSTMT_ID * new_statement_id, SQLSTMT_ID *cloned_statement,
										const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_AllocStmt",("new_statement_id=0x%08x, cloned_statement=0x%08x",
			new_statement_id,
			cloned_statement),
		filename, line);
...
SQLCLI_LIB_FUNC long CliDebug_ResDescName(SQLDESC_ID *statement_id, SQLSTMT_ID *from_statement, long what_desc,
										  const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_ResDescName",("statement_id=0x%08x, from_statement=0x%08x, what_desc=%s",
			statement_id,
			from_statement,
...
SQLCLI_LIB_FUNC long CliDebug_AllocDesc(SQLDESC_ID *desc_id, SQLDESC_ID *input_descriptor,
										const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_AllocDesc",("desc_id=0x%08x, input_descriptor=0x%08x",
			desc_id,
			input_descriptor),
		filename, line);
...
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelStmt,"SQL_EXEC_AllocStmtForRS",
...
SQLCLI_LIB_FUNC long CliDebug_AssocFileNumber(SQLSTMT_ID *statement_id, short file_number,
											  const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_AssocFileNumber",("statement_id=0x%08x, file_number=%d",
			statement_id,
			file_number),
		filename, line);
...
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_CLI_VERSION",(NULL),
		filename, line);
...
SQLCLI_LIB_FUNC long CliDebug_ClearExecFetchClose(SQLSTMT_ID *statement_id, SQLDESC_ID *input_descriptor,
												  ...
												  const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_ClearExecFetchClose",
...
SQLCLI_LIB_FUNC long CliDebug_GetStmtAttr(SQLSTMT_ID *statement_id, long attrName,
										  ...
										  const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelCLI,"SQL_EXEC_GetStmtAttr",
...
jsize JNIDebug_GetArrayLength(JNIEnv *jenv, jarray array,
							  const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->GetArrayLength",(NULL),
		filename, line);
...
jobject JNIDebug_GetObjectArrayElement(JNIEnv *jenv, jobjectArray array, jsize index,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->GetObjectArrayElement",
		("index=%ld",index),
		filename, line);
...
jobject JNIDebug_GetObjectField(JNIEnv *jenv, jobject jobj, jfieldID fieldID,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->GetObjectField",(NULL),
		filename, line);
...
jbyte *JNIDebug_GetByteArrayElements(JNIEnv *jenv, jbyteArray array, jboolean *isCopy,
									const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->GetByteArrayElements",(NULL),
		filename, line);
...
void JNIDebug_ReleaseByteArrayElements(JNIEnv *jenv, jbyteArray array, jbyte *elems, jint mode,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->ReleaseByteArrayElements",(NULL),
		filename, line);
...
jshort *JNIDebug_GetShortArrayElements(JNIEnv *jenv, jshortArray array, jboolean *isCopy,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->GetShortArrayElements",(NULL),
		filename, line);
...
void JNIDebug_ReleaseShortArrayElements(JNIEnv *jenv, jshortArray array, jshort *elems, jint mode,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->ReleaseShortArrayElements",(NULL),
		filename, line);
...
jint *JNIDebug_GetIntArrayElements(JNIEnv *jenv, jintArray array, jboolean *isCopy,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->GetIntArrayElements",(NULL),
		filename, line);
...
void JNIDebug_ReleaseIntArrayElements(JNIEnv *jenv, jintArray array, jint *elems, jint mode,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->ReleaseIntArrayElements",(NULL),
		filename, line);
...
jlong *JNIDebug_GetLongArrayElements(JNIEnv *jenv, jlongArray array, jboolean *isCopy,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->GetLongArrayElements",(NULL),
		filename, line);
...
void JNIDebug_ReleaseLongArrayElements(JNIEnv *jenv, jlongArray array, jlong *elems, jint mode,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->ReleaseLongArrayElements",(NULL),
		filename, line);
...
jfloat *JNIDebug_GetFloatArrayElements(JNIEnv *jenv, jfloatArray array, jboolean *isCopy,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->GetFloatArrayElements",(NULL),
		filename, line);
...
void JNIDebug_ReleaseFloatArrayElements(JNIEnv *jenv, jfloatArray array, jfloat *elems, jint mode,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->ReleaseFloatArrayElements",(NULL),
		filename, line);
...
jdouble *JNIDebug_GetDoubleArrayElements(JNIEnv *jenv, jdoubleArray array, jboolean *isCopy,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->GetDoubleArrayElements",(NULL),
		filename, line);
...
void JNIDebug_ReleaseDoubleArrayElements(JNIEnv *jenv, jdoubleArray array, jdouble *elems, jint mode,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->ReleaseDoubleArrayElements",(NULL),
		filename, line);
...
jboolean *JNIDebug_GetBooleanArrayElements(JNIEnv *jenv, jbooleanArray array, jboolean *isCopy,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->GetBooleanArrayElements",(NULL),
		filename, line);
...
void JNIDebug_ReleaseBooleanArrayElements(JNIEnv *jenv, jbooleanArray array, jboolean *elems, jint mode,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->ReleaseBooleanArrayElements",(NULL),
		filename, line);
...
const char *JNIDebug_GetStringUTFChars(JNIEnv *jenv, jstring jstr, jboolean *isCopy,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->GetStringUTFChars",(NULL),
		filename, line);
...
void JNIDebug_ReleaseStringUTFChars(JNIEnv *jenv, jstring jstr, const char* chars,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->ReleaseStringUTFChars",(NULL),
		filename, line);
...
jmethodID JNIDebug_GetMethodID(JNIEnv *jenv, jclass jcls, const char *name, const char *sig,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->GetMethodID",
...
jfieldID JNIDebug_GetFieldID(JNIEnv *jenv, jclass jcls, const char *name, const char *sig,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->GetFieldID",
		("name='%s' sig='%s'",name,sig),
		filename, line);
...
jclass JNIDebug_GetObjectClass(JNIEnv *jenv, jobject jobj,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->GetObjectClass",(NULL),
		filename, line);
...
jboolean JNIDebug_IsInstanceOf(JNIEnv *jenv, jobject jobj, jclass clazz,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->IsInstanceOf",
...
void JNIDebug_SetObjectField(JNIEnv *jenv, jobject jobj, jfieldID fieldID, jobject val,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetObjectField",
		(NULL),
		filename, line);
...
void JNIDebug_SetBooleanField(JNIEnv *jenv, jobject jobj, jfieldID fieldID, jboolean val,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetBooleanField",
		("val=%d",val),
		filename, line);
...
void JNIDebug_SetByteField(JNIEnv *jenv, jobject jobj, jfieldID fieldID, jbyte val,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetByteField",
		("val=%d",val),
		filename, line);
...
void JNIDebug_SetShortField(JNIEnv *jenv, jobject jobj, jfieldID fieldID, jshort val,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetShortField",
		("val=%d",val),
		filename, line);
...
void JNIDebug_SetIntField(JNIEnv *jenv, jobject jobj, jfieldID fieldID, jint val,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetIntField",
		("val=%ld",val),
		filename, line);
...
void JNIDebug_SetLongField(JNIEnv *jenv, jobject jobj, jfieldID fieldID, jlong val,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetLongField",
		("val=%Ld",val),
		filename, line);
...
void JNIDebug_SetFloatField(JNIEnv *jenv, jobject jobj, jfieldID fieldID, jfloat val,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetFloatField",
		("val=%f",val),
		filename, line);
...
void JNIDebug_SetDoubleField(JNIEnv *jenv, jobject jobj, jfieldID fieldID, jdouble val,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetDoubleField",
		("val=%g",val),
		filename, line);
...
void JNIDebug_SetObjectArrayElement(JNIEnv *jenv, jobjectArray array, jsize index, jobject val,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetObjectArrayElement",
		("index=%ld",index),
		filename, line);
...
void JNIDebug_SetBooleanArrayRegion(JNIEnv *jenv, jbooleanArray array, jsize start, jsize len, jboolean *buf,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetBooleanArrayRegion",
		((NULL)),
		filename, line);
...
void JNIDebug_SetByteArrayRegion(JNIEnv *jenv, jbyteArray array, jsize start, jsize len, jbyte *buf,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetByteArrayRegion",
		((NULL)),
		filename, line);
...
void JNIDebug_SetCharArrayRegion(JNIEnv *jenv, jcharArray array, jsize start, jsize len, jchar *buf,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetCharArrayRegion",
		((NULL)),
		filename, line);
...
void JNIDebug_SetShortArrayRegion(JNIEnv *jenv, jshortArray array, jsize start, jsize len, jshort *buf,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetShortArrayRegion",
		((NULL)),
		filename, line);
...
void JNIDebug_SetIntArrayRegion(JNIEnv *jenv, jintArray array, jsize start, jsize len, jint *buf,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetIntArrayRegion",
		((NULL)),
		filename, line);
...
void JNIDebug_SetLongArrayRegion(JNIEnv *jenv, jlongArray array, jsize start, jsize len, jlong *buf,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetLongArrayRegion",
		((NULL)),
		filename, line);
...
void JNIDebug_SetFloatArrayRegion(JNIEnv *jenv, jfloatArray array, jsize start, jsize len, jfloat *buf,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetFloatArrayRegion",
		((NULL)),
		filename, line);
...
void JNIDebug_SetDoubleArrayRegion(JNIEnv *jenv, jdoubleArray array, jsize start, jsize len, jdouble *buf,
									   const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->SetDoubleArrayRegion",
		((NULL)),
		filename, line);
...
jbyteArray JNIDebug_NewByteArray(JNIEnv *jenv, jsize len,
								 const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->NewByteArray",
		("len=%ld",len),
		filename, line);
...
jintArray JNIDebug_NewIntArray(JNIEnv *jenv, jsize len,
								 const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->NewIntArray",
		("len=%ld",len),
		filename, line);
...
jobjectArray JNIDebug_NewObjectArray(JNIEnv *jenv, jsize len, jclass clazz, jobject init,
								 const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->NewObjectArray",
		("len=%ld",len),
		filename, line);
...
void JNIDebug_ExceptionClear(JNIEnv *jenv,
							 const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->ExceptionClear",
		((NULL)),
		filename, line);
	jenv->ExceptionClear();
	FUNCTION_RETURN_VOID_LOC((NULL),filename,line);
...
jint JNIDebug_Throw(JNIEnv *jenv, jthrowable obj,
					const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->Throw",
		((NULL)),
		filename, line);
...
jclass JNIDebug_FindClass(JNIEnv *jenv, const char *name,
					const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->FindClass",
		(("name=%s",name)),
		filename, line);
...
jobject JNIDebug_NewGlobalRef(JNIEnv *jenv, jobject lobj,
					const char *filename, unsigned long line)
{
	FUNCTION_ENTRY_LEVEL_LOC(org_trafodion_sql_JdbcDebug_debugLevelEntry,"jenv->NewGlobalRef",
		((NULL)),
		filename, line);
...
const char *WrapperDataTypeStr(jbyte dataType)
{
	...
	switch (dataType)
	{
	case org_trafodion_sql_DataWrapper_UNKNOWN:
		return("DataWrapper.UNKNOWN");
	case org_trafodion_sql_DataWrapper_BYTE:
		return("DataWrapper.BYTE");
	case org_trafodion_sql_DataWrapper_SHORT:
		return("DataWrapper.SHORT");
	case org_trafodion_sql_DataWrapper_INTEGER:
		return("DataWrapper.INTEGER");
	case org_trafodion_sql_DataWrapper_LONG:
		return("DataWrapper.LONG");
	case org_trafodion_sql_DataWrapper_FLOAT:
		return("DataWrapper.FLOAT");
	case org_trafodion_sql_DataWrapper_DOUBLE:
		return("DataWrapper.DOUBLE");
	case org_trafodion_sql_DataWrapper_BOOLEAN:
		return("DataWrapper.BOOLEAN");
	case org_trafodion_sql_DataWrapper_STRING:
		return("DataWrapper.STRING");
	case org_trafodion_sql_DataWrapper_BYTES:
		return("DataWrapper.BYTES");
	case org_trafodion_sql_DataWrapper_BLOB:
		return("DataWrapper.BLOB");
	case org_trafodion_sql_DataWrapper_CLOB:
		return("DataWrapper.CLOB");
	case org_trafodion_sql_DataWrapper_BIG_DECIMAL:
		return("DataWrapper.BIG_DECIMAL");
	case org_trafodion_sql_DataWrapper_OBJECT:
