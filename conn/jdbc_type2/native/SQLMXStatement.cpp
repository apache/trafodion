...
#include "org_trafodion_sql_SQLMXStatement.h"
#include "SQLMXCommonFunctions.h"
#include "CSrvrConnect.h"
#include "Debug.h"

JNIEXPORT void JNICALL Java_org_trafodion_sql_SQLMXStatement_executeDirect
...
{
	FUNCTION_ENTRY_LEVEL(DEBUG_LEVEL_STMT,"Java_org_trafodion_sql_SQLMXStatement_executeDirect",
...
JNIEXPORT void JNICALL Java_org_trafodion_sql_SQLMXStatement_executeRS
  (JNIEnv *jenv, jobject jobj, jstring server, jlong dialogueId, jint txid, jboolean autoCommit, jint txnMode,
  jstring stmtLabel, jstring RSstmtLabel,  jboolean isSelect, jlong stmtId, jint ResultSetIndex, jobject resultSet)
{
	FUNCTION_ENTRY_LEVEL(DEBUG_LEVEL_STMT, "Java_org_trafodion_sql_SQLMXStatement_executeRS",		
...
//venu changed dialogueId and stmtId from int to long for 64 bit
JNIEXPORT jint JNICALL Java_org_trafodion_sql_SQLMXStatement_close
  (JNIEnv *jenv, jclass jclass, jstring server, jlong dialogueId, 
		jlong stmtId, jboolean dropStmt)
{
	FUNCTION_ENTRY("Java_org_trafodion_sql_SQLMXStatement_close",
 ...
 */
JNIEXPORT void JNICALL Java_org_trafodion_sql_SQLMXStatement_executeBatch
  (JNIEnv *jenv, jobject jobj, jstring server, jlong dialogueId, jint txid, jboolean autoCommit, jint txnMode,  
...
{
	FUNCTION_ENTRY("Java_org_trafodion_sql_SQLMXStatement_executeBatch",
...
JNIEXPORT void JNICALL Java_org_trafodion_sql_SQLMXStatement_closeUsingLabel
  (JNIEnv *jenv, jclass jclass, jstring server, jlong dialogueId, 
		jstring stmtLabel, jboolean dropStmt)
{
	FUNCTION_ENTRY("Java_org_trafodion_sql_SQLMXStatement_closeUsingLabel",("... stmtLabel=%s, dialogueId=0x%08x, dropStmt=%s",
		DebugJString(jenv,stmtLabel),
		dialogueId,
		DebugBoolStr(dropStmt)));
...
//venu changed dialogueId and stmtId from int to long for 64 bit
JNIEXPORT void JNICALL Java_org_trafodion_sql_SQLMXStatement_cancel
  (JNIEnv *jenv, jobject jobj, jstring server, jlong dialogueId, jlong stmtId)
{
	FUNCTION_ENTRY("Java_org_trafodion_sql_SQLMXStatement_cancel",("..."));
...
//venu changed dialogueId and stmtId from int to long for 64 bit
JNIEXPORT void JNICALL Java_org_trafodion_sql_SQLMXStatement_resetFetchSize
  (JNIEnv *, jobject, jlong dialogueId, jlong stmtId, jint fetchSize)
{
	FUNCTION_ENTRY("Java_org_trafodion_sql_SQLMXStatement_resetFetchSize",
...
long SQLMXStatement_EXECUTE_FAILED(void)
{
	...
	FUNCTION_RETURN_NUMERIC(org_trafodion_sql_SQLMXStatement_JNI_EXECUTE_FAILED,
		("org_trafodion_sql_SQLMXStatement_JNI_EXECUTE_FAILED"));
}

long SQLMXStatement_SUCCESS_NO_INFO(void)
{
	FUNCTION_ENTRY("SQLMXStatement_SUCCESS_NO_INFO",(NULL));
	FUNCTION_RETURN_NUMERIC(org_trafodion_sql_SQLMXStatement_JNI_SUCCESS_NO_INFO,
		("org_trafodion_sql_SQLMXStatement_JNI_SUCCESS_NO_INFO"));
}