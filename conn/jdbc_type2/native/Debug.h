...
#define DEBUG_FLAG_THREADS		org_trafodion_sql_JdbcDebug_debugFlagThreads
#define DEBUG_FLAG_DIRTY_MEM	org_trafodion_sql_JdbcDebug_debugFlagDirtyMem
#define DEBUG_FLAG_TIMER		org_trafodion_sql_JdbcDebug_debugFlagTimer
#define DEBUG_FLAG_NOTIME		org_trafodion_sql_JdbcDebug_debugFlagNoTime
#define DEBUG_FLAG_TESTWARE		org_trafodion_sql_JdbcDebug_debugFlagTestware
#define DEBUG_LEVEL_ENTRY		org_trafodion_sql_JdbcDebug_debugLevelEntry
#define DEBUG_LEVEL_JAVA		org_trafodion_sql_JdbcDebug_debugLevelJava
#define DEBUG_LEVEL_MEM			org_trafodion_sql_JdbcDebug_debugLevelMem
#define DEBUG_LEVEL_MEMLEAK		org_trafodion_sql_JdbcDebug_debugLevelMemLeak
#define DEBUG_LEVEL_CLI			org_trafodion_sql_JdbcDebug_debugLevelCLI
#define DEBUG_LEVEL_DATA		org_trafodion_sql_JdbcDebug_debugLevelData
#define DEBUG_LEVEL_TXN			org_trafodion_sql_JdbcDebug_debugLevelTxn
#define DEBUG_LEVEL_ROWSET		org_trafodion_sql_JdbcDebug_debugLevelRowset
#define DEBUG_LEVEL_ERROR		org_trafodion_sql_JdbcDebug_debugLevelError
#define DEBUG_LEVEL_METADATA	org_trafodion_sql_JdbcDebug_debugLevelMetadata
#define DEBUG_LEVEL_UNICODE		org_trafodion_sql_JdbcDebug_debugLevelUnicode
#define DEBUG_LEVEL_POOLING		org_trafodion_sql_JdbcDebug_debugLevelPooling
#define DEBUG_LEVEL_STMT		org_trafodion_sql_JdbcDebug_debugLevelStmt
#define DEBUG_LEVEL_ALL			org_trafodion_sql_JdbcDebug_debugLevelAll
