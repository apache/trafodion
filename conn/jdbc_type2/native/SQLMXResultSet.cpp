...
#include "org_trafodion_sql_SQLMXResultSet.h"
#include "org_trafodion_sql_SQLMXStatement.h"
#include "CSrvrStmt.h"
#include "SrvrCommon.h"
#include "Debug.h"

JNIEXPORT jboolean JNICALL Java_org_trafodion_sql_SQLMXResultSet_fetchN
...
{
	FUNCTION_ENTRY("Java_org_trafodion_sql_SQLMXResultSet_fetchN",("server=%s, dialogueId=0x%08x, txid=0x%08x, txnMode=%ld, stmtId=0x%08x, maxRowCnt=%ld, queryTimeout=%ld, holdability=%ld",
...
JNIEXPORT void JNICALL Java_org_trafodion_sql_SQLMXResultSet_close
...
{
	FUNCTION_ENTRY("Java_org_trafodion_sql_SQLMXResultSet_close",("server=%s, dialogueId=0x%08x, txid=0x%08x, autoCommit=%s, txnMode=%ld, stmtId=0x%08x, dropStmt=%s",
		DebugJString(jenv,server),
		dialogueId,
		txid,
...
//venu changed dialogueId and stmtId from int to long for 64 bit 
JNIEXPORT void JNICALL Java_org_trafodion_sql_SQLMXResultSet_getResultSetInfo
  (JNIEnv *jenv, jobject jobj, jlong dialogueId, jlong stmtId, jobject RSInfo)
{
	FUNCTION_ENTRY_LEVEL(DEBUG_LEVEL_STMT,"Java_org_trafodion_sql_SQLMXResultSet_getResultSetInfo",
