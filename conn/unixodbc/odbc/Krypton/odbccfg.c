 ...
 */
static void
odbccfg_CfgSvc_CreateConfigurationDatabase_amw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbccfg_CfgSvc_CreateConfigurationDatabase_amt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbccfg_CfgSvc_CreateConfigurationDatabase_smw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbccfg_CfgSvc_CreateConfigurationDatabase_smt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbccfg_CfgSvc_CreateDatatypeTable_amw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbccfg_CfgSvc_CreateDatatypeTable_amt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbccfg_CfgSvc_CreateDatatypeTable_smw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbccfg_CfgSvc_CreateDatatypeTable_smt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbccfg_CfgSvc_DropConfigurationDatabase_amw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbccfg_CfgSvc_DropConfigurationDatabase_amt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbccfg_CfgSvc_DropConfigurationDatabase_smw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbccfg_CfgSvc_DropConfigurationDatabase_smt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbccfg_CfgSvc_DropDatatypeTable_amw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbccfg_CfgSvc_DropDatatypeTable_amt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbccfg_CfgSvc_DropDatatypeTable_smw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbccfg_CfgSvc_DropDatatypeTable_smt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbccfg_CfgSvc_UserAuthenticate_amw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbccfg_CfgSvc_UserAuthenticate_amt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
    , (USER_NAME_def *) pv_[1]
    , (USER_PASSWORD_def *) pv_[2]
    );
}
/*
 * Set Asynchronous Method for
  ...
  )
{
  ...
  pv_[2] = (void *) &retCode;
  pv_[3] = (void *) &status;
  pv_[4] = (void *) &authenticated;
  pv_[5] = (void *) &authorized;
  return CEE_RESPOND(
      call_id_
    , pv_);
}
 ...
 */
static void
odbccfg_CfgSvc_UserAuthenticate_smw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbccfg_CfgSvc_UserAuthenticate_smt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbccfg_CfgSvc_ChangePassword_amw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbccfg_CfgSvc_ChangePassword_amt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbccfg_CfgSvc_ChangePassword_smw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbccfg_CfgSvc_ChangePassword_smt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbccfg_CfgSvc_GeneralParam_amw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbccfg_CfgSvc_GeneralParam_amt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
 ...
 */
static void
odbccfg_CfgSvc_GeneralParam_smw_(
    /* In    */ CEE_tag_def mettag_
  , /* In    */ CEE_tag_def objtag_
  , /* In    */ const CEE_handle_def *call_id_
  , /* In    */ void *const *pv_)
{
  odbccfg_CfgSvc_GeneralParam_smt_ f_;
  *((CEE_tag_def *) &f_) = mettag_;
  (*f_) (
      objtag_
    , call_id_
  ...
  /* In  */ ...)
{
  ...
  if ((sts = CEE_SET_METHOD(&impl, 1, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_GetObjectNameList_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 2, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_GetDataSource_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 3, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_DropDataSource_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 4, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_SetDataSource_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 5, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_AddNewDataSource_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 6, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_CheckDataSourceName_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 7, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_GetDSNControl_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 8, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_SetDSNControl_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 9, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_GetResourceValues_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 10, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_SetResourceValues_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 11, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_GetEnvironmentValues_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 12, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_SetEnvironmentValues_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 13, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_GetStartupConfigValues_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 14, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_GetDataSourceValues_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 15, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_SetDSStatus_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 16, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_SetASStatus_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 17, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_CreateConfigurationDatabase_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 18, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_CreateDatatypeTable_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 19, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_DropConfigurationDatabase_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 20, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_DropDatatypeTable_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 21, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_UserAuthenticate_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 22, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_ChangePassword_amw_)) != CEE_SUCCESS)
    goto error_1;
  if ((sts = CEE_SET_METHOD(&impl, 23, va_arg(argptr, CEE_tag_def),
                            CEE_ASYNCH_METHOD,
                            odbccfg_CfgSvc_GeneralParam_amw_)) != CEE_SUCCESS)
    goto error_1;
  *implementation_handle = impl;
  CEE_INTERFACE_DESTROY(&intf);
  return CEE_SUCCESS;
