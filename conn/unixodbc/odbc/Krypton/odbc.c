 ...
 */
static void
odbc_SQLSvc_ExecuteRowset_ccw_(
    /* In    */ CEE_tag_def tag1_
  , /* In    */ CEE_tag_def tag2_
  , /* In    */ const void *const *pv_)
{
  odbc_SQLSvc_ExecuteRowset_cct_ f_;
  *((CEE_tag_def *) &f_) = tag1_;
  (*f_) (
      tag2_
  ...
  )
{
  ...
  pv_[4] = (void *) &sqlStmtType;
  pv_[5] = (void *) &inputRowCnt;
  pv_[6] = (void *) inputDataValue;
  pv_[7] = (void *) &sqlAsyncEnable;
  pv_[8] = (void *) &queryTimeout;
  return CEE_OBJECT_CALL_POST(
    ph_
  , 22 /* = odbc_SQLSvc_ExecuteRowset_ldx_ */
  , pv_
  , odbc_SQLSvc_ExecuteRowset_ccw_
  , *((CEE_tag_def *) &rtn_)
  , tag_);
 ...
 */
static void
odbc_SQLSvc_EnableServerTrace_ccw_(
    /* In    */ CEE_tag_def tag1_
  , /* In    */ CEE_tag_def tag2_
  , /* In    */ const void *const *pv_)
{
  odbc_SQLSvc_EnableServerTrace_cct_ f_;
  *((CEE_tag_def *) &f_) = tag1_;
  (*f_) (
      tag2_
  ...
  )
{
  ...
  return CEE_OBJECT_CALL_POST(
    ph_
  , 23 /* = odbc_SQLSvc_EnableServerTrace_ldx_ */
  , pv_
  , odbc_SQLSvc_EnableServerTrace_ccw_
  , *((CEE_tag_def *) &rtn_)
  , tag_);
 ...
 */
static void
odbc_SQLSvc_DisableServerTrace_ccw_(
    /* In    */ CEE_tag_def tag1_
  , /* In    */ CEE_tag_def tag2_
  , /* In    */ const void *const *pv_)
{
  odbc_SQLSvc_DisableServerTrace_cct_ f_;
  *((CEE_tag_def *) &f_) = tag1_;
  (*f_) (
      tag2_
  ...
  )
{
  ...
  return CEE_OBJECT_CALL_POST(
    ph_
  , 24 /* = odbc_SQLSvc_DisableServerTrace_ldx_ */
  , pv_
  , odbc_SQLSvc_DisableServerTrace_ccw_
  , *((CEE_tag_def *) &rtn_)
  , tag_);
 ...
 */
static void
odbc_SQLSvc_EnableServerStatistics_ccw_(
    /* In    */ CEE_tag_def tag1_
  , /* In    */ CEE_tag_def tag2_
  , /* In    */ const void *const *pv_)
{
  odbc_SQLSvc_EnableServerStatistics_cct_ f_;
  *((CEE_tag_def *) &f_) = tag1_;
  (*f_) (
      tag2_
  ...
  )
{
  ...
  pv_[0] = &osy_;
  pv_[1] = (void *) &dialogueId;
  pv_[2] = (void *) &StatisticsType;
  return CEE_OBJECT_CALL_POST(
    ph_
  , 25 /* = odbc_SQLSvc_EnableServerStatistics_ldx_ */
  , pv_
  , odbc_SQLSvc_EnableServerStatistics_ccw_
  , *((CEE_tag_def *) &rtn_)
  , tag_);
 ...
 */
static void
odbc_SQLSvc_DisableServerStatistics_ccw_(
    /* In    */ CEE_tag_def tag1_
  , /* In    */ CEE_tag_def tag2_
  , /* In    */ const void *const *pv_)
{
  odbc_SQLSvc_DisableServerStatistics_cct_ f_;
  *((CEE_tag_def *) &f_) = tag1_;
  (*f_) (
      tag2_
  ...
  )
{
  ...
  return CEE_OBJECT_CALL_POST(
    ph_
  , 26 /* = odbc_SQLSvc_DisableServerStatistics_ldx_ */
  , pv_
  , odbc_SQLSvc_DisableServerStatistics_ccw_
  , *((CEE_tag_def *) &rtn_)
  , tag_);
 ...
 */
static void
odbc_SQLSvc_UpdateServerContext_ccw_(
    /* In    */ CEE_tag_def tag1_
  , /* In    */ CEE_tag_def tag2_
  , /* In    */ const void *const *pv_)
{
  odbc_SQLSvc_UpdateServerContext_cct_ f_;
  *((CEE_tag_def *) &f_) = tag1_;
  (*f_) (
      tag2_
  ...
  )
{
  ...
  const void *pv_[2];
  pv_[0] = &osy_;
  pv_[1] = (void *) srvrContext;
  return CEE_OBJECT_CALL_POST(
    ph_
  , 27 /* = odbc_SQLSvc_UpdateServerContext_ldx_ */
  , pv_
  , odbc_SQLSvc_UpdateServerContext_ccw_
  , *((CEE_tag_def *) &rtn_)
  , tag_);
 ...
 */
static void
odbc_SQLSvc_ExecuteCall_ccw_(
    /* In    */ CEE_tag_def tag1_
  , /* In    */ CEE_tag_def tag2_
  , /* In    */ const void *const *pv_)
{
  odbc_SQLSvc_ExecuteCall_cct_ f_;
  *((CEE_tag_def *) &f_) = tag1_;
  (*f_) (
      tag2_
    , (struct odbc_SQLSvc_ExecuteCall_exc_ *) pv_[1]
    , (SQLValueList_def *) pv_[2]
    , *(IDL_long *) pv_[3]
    , (ERROR_DESC_LIST_def *) pv_[4]
    );
}
  ...
  )
{
  ...
  return CEE_OBJECT_CALL_POST(
    ph_
  , 28 /* = odbc_SQLSvc_ExecuteCall_ldx_ */
  , pv_
  , odbc_SQLSvc_ExecuteCall_ccw_
  , *((CEE_tag_def *) &rtn_)
  , tag_);
  ...
  )
{
  ...
  pv_[8] = (void *) &sqlAsyncEnable;
  pv_[9] = (void *) &queryTimeout;
  pv_[10] = (void *) outputValueList;
  pv_[11] = (void *) rowsAffected;
  pv_[12] = (void *) sqlWarning;
  CEE_OBJECT_CALL(
      ph_
    , 28  /* = odbc_SQLSvc_ExecuteCall_ldx_ */
