...
{
  /// <summary>
  /// Wrapper class extending the HPMenuStrip class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
  public  class TrafodionMenuStrip : MenuStrip  
   {
