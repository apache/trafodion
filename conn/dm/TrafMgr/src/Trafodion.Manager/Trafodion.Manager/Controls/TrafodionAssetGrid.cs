...
{
  /// <summary>
  /// Wrapper class extending the HPAssetGrid class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(AssetGrid))]
    public class TrafodionAssetGrid : AssetGrid  
   {
