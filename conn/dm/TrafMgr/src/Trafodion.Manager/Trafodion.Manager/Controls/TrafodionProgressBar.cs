...
{
  /// <summary>
  /// Wrapper class extending the ProgressBar class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(ProgressBar))]
    public class TrafodionProgressBar : ProgressBar  
   {
