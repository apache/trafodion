...
{
  /// <summary>
  /// Wrapper class extending the HPImageComboBox class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(ImageComboBox))]
    public class TrafodionImageComboBox : ImageComboBox  
   {
