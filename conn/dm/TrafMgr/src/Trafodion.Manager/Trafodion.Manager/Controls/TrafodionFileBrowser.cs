...
{
  /// <summary>
  /// Wrapper class extending the HPFileBrowser class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>

    [DefaultPropertyAttribute("CurrentDirectory")]
    [ToolboxBitmapAttribute(typeof(FileBrowser))]
    public class TrafodionFileBrowser : FileBrowser
    {
