...
{
  /// <summary>
  /// Wrapper class extending the ToolBar class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(ToolBar))]
  public class TrafodionToolBar : ToolBar  
  {
