...
{
  /// <summary>
  /// Wrapper class extending the DataGridBoolColumn class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
  public  class TrafodionDataGridBoolColumn : DataGridBoolColumn  
   {
      ...
      /// Constructor
      /// </summary>
      public TrafodionDataGridBoolColumn()
          : base()
      {
