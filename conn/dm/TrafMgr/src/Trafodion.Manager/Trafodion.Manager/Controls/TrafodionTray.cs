...
{
  /// <summary>
  /// Wrapper class extending the HPTray class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
  [ToolboxBitmapAttribute(typeof(Tray))]
  [DefaultPropertyAttribute("Text")]
  public  class TrafodionTray : Tray  
   {
