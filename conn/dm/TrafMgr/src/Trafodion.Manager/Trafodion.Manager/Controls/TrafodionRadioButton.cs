...
{
  /// <summary>
  /// Wrapper class extending the HPRadioButton class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [DefaultPropertyAttribute("Text")]
    [DefaultEventAttribute("Click")]
    [ToolboxBitmapAttribute(typeof(RadioButton))]
    public  class TrafodionRadioButton : RadioButton  
    {
