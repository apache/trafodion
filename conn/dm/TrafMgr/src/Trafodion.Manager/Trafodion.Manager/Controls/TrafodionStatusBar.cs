...
{
  /// <summary>
  /// Wrapper class extending the HPStatusBar class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(StatusBar))]
    public class TrafodionStatusBar : StatusBar  
   {
