...
{
  /// <summary>
  /// Wrapper class extending the HPLayoutControlCollection class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
  public  class TrafodionLayoutControlCollection : LayoutControlCollection  
   {
      ...
      /// Constructor
      /// </summary>
      public TrafodionLayoutControlCollection(System.Windows.Forms.Control owner) : base(owner)
      {
