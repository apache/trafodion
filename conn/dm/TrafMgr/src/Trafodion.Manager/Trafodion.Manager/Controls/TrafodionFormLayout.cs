...
{
  /// <summary>
  /// Wrapper class extending the HPFormLayout class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
  public  class TrafodionFormLayout : FormLayout  
   {
      ...
      /// Constructor
      /// </summary>
      public TrafodionFormLayout(HPOneVoice.HPLayoutControl c)
          : base(c)
      {
