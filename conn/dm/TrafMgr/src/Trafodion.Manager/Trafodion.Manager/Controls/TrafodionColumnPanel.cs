...
{
  /// <summary>
  /// Wrapper class extending the HPColumnPanel class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(ColumnPanel))]
    public class TrafodionColumnPanel : ColumnPanel  
   {
