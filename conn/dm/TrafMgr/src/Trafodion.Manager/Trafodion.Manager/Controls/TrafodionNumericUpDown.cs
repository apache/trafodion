...
{
  /// <summary>
  /// Wrapper class extending the NumericUpDown class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(NumericUpDown))]
    public class TrafodionNumericUpDown : NumericUpDown  
   {
