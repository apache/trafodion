...
{
  /// <summary>
  /// Wrapper class extending the HPSummaryDataGrid class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(HPSummaryDataGrid))]
    public class TrafodionSummaryDataGrid : HPSummaryDataGrid  
   {
      ...
      /// Constructor
      /// </summary>
      public TrafodionSummaryDataGrid()
          : base()
      {
