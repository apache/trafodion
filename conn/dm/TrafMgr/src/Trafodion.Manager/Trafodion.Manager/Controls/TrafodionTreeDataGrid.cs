...
{
  /// <summary>
  /// Wrapper class extending the HPTreeDataGrid class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(TreeDataGrid))]
    public class TrafodionTreeDataGrid : TreeDataGrid  
   {
