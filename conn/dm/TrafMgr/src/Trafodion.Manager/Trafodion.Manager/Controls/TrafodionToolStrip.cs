...
{
  /// <summary>
  /// Wrapper class extending the ToolStrip class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
  public  class TrafodionToolStrip : ToolStrip  
   {
          ...
          : base()
      {
          ...
          this.Renderer = new TrafodionToolStripRenderer(new ProfessionalColorTable());
      }
      ...
      /// Constructor
      /// </summary>
      public TrafodionToolStrip(System.Windows.Forms.ToolStripItem[] items)
          : base(items)
      {
          //Changes the theme when the theme is changed for the framework and
          //also sets the default theme
