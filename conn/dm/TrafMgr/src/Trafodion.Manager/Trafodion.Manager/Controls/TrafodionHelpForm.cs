...
{
  /// <summary>
  /// Wrapper class extending the HPHelpForm class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(HelpForm))]
    public class TrafodionHelpForm : HelpForm  
   {
