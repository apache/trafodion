...
{
  /// <summary>
  /// Wrapper class extending the HPFormPanel class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(FormPanel))]
    public class TrafodionFormPanel : FormPanel  
   {
