...
{
  /// <summary>
  /// Wrapper class extending the HPThumbnailGrid class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(ThumbnailGrid))]
    public class TrafodionThumbnailGrid : ThumbnailGrid  
   {
