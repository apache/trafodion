...
{
  /// <summary>
  /// Wrapper class extending the HPNavigation class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(Navigation))]
    public class TrafodionNavigation : Navigation  
   {
