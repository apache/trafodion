...
{
  /// <summary>
  /// Wrapper class extending the HPMultiPageDataGrid class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(MultiPageDataGrid))]
    public class TrafodionMultiPageDataGrid : MultiPageDataGrid  
   {
      ...
      /// Constructor
      /// </summary>
      public TrafodionMultiPageDataGrid()
          : base()
      {
