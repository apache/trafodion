...
{
  /// <summary>
  /// Wrapper class extending the HPLayoutPanel class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(LayoutPanel))]
    public abstract class TrafodionLayoutPanel : LayoutPanel  
   {
