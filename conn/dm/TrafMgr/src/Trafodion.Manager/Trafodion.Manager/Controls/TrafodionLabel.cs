...
{
  /// <summary>
  /// Wrapper class extending the HPLabel class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(Label))]
    [DefaultPropertyAttribute("Text")]
    public class TrafodionLabel : Label  
   {
