...
{
  /// <summary>
  /// Wrapper class extending the HPToolTip class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(ToolTip))]
    [ProvidePropertyAttribute("ToolTip", typeof(ToolTip))]
    public  class TrafodionToolTip : ToolTip
    {
        ...
        /// Constructor
        /// </summary>
        public TrafodionToolTip(IContainer cont)
            : base(cont)
        {
            //Changes the theme when the theme is changed for the framework and
            //also sets the default theme
