...
{
  /// <summary>
  /// Wrapper class extending the HPContextHelp class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>

    [ProvidePropertyAttribute("ContextualHelp", typeof(ContextHelp))]
    [ToolboxBitmapAttribute(typeof(ContextHelp))]
    public  class TrafodionContextHelp : ContextHelp  
    {
