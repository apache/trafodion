...
{
  /// <summary>
  /// Wrapper class extending the HPAboutScreen class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(AboutScreen))]
    public  class TrafodionAboutScreen : AboutBox  
   {
      private TrafodionLookAndFeelChangeHandler lookAndFeelChangeHandler = null;
      /// <summary>
      /// Constructor
      /// </summary>
      public TrafodionAboutScreen()
          : base()
      {
