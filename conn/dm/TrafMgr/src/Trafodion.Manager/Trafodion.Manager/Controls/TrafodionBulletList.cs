...
{
  /// <summary>
  /// Wrapper class extending the HPBulletList class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>

    [ToolboxBitmapAttribute(typeof(BulletList))]
    public  class TrafodionBulletList : BulletList  
    {
      ...
      public TrafodionBulletList() : base()
      {
