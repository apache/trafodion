...
{
  /// <summary>
  /// Wrapper class extending the DataGridTextBoxColumn class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    public class TrafodionDataGridTextBoxColumn : DataGridTextBoxColumn  
   {
        ...
        /// Constructor
        /// </summary>
        public TrafodionDataGridTextBoxColumn()
            : base()
        {
