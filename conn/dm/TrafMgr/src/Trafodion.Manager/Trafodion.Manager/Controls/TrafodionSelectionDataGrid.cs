...
{
  /// <summary>
  /// Wrapper class extending the HPSelectionDataGrid class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(SelectionDataGrid))]
    public class TrafodionSelectionDataGrid : SelectionDataGrid  
   {
      ...
      /// Constructor
      /// </summary>
      public TrafodionSelectionDataGrid()
          : base()
      {
