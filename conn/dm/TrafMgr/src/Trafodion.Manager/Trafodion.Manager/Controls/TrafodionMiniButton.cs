...
{
  /// <summary>
  /// Wrapper class extending the HPMiniButton class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [DefaultPropertyAttribute("Text")]
    [ToolboxBitmapAttribute(typeof(Button))]
    [DefaultEventAttribute("Click")]
    public  class TrafodionMiniButton : Button  
    {
        ...
        /// Constructor
        /// </summary>
        public TrafodionMiniButton() : base()
        {
