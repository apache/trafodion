...
{
  /// <summary>
  /// Wrapper class extending the HPFilterDataGrid class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(DataGrid))]
    public class TrafodionFilterDataGrid : DataGrid  
   {
      ...
      /// Constructor
      /// </summary>
      public TrafodionFilterDataGrid()
          : base()
      {
