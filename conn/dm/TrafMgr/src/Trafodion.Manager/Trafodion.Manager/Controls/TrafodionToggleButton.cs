...
{
  /// <summary>
  /// Wrapper class extending the HPToggleButton class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// A toggle button is the same as a regular button except it holds its pressed state as an on/off switch. 
  /// You can set its state with the Value property. 
  /// </summary>
  public  class TrafodionToggleButton : ToggleButton  
   {
