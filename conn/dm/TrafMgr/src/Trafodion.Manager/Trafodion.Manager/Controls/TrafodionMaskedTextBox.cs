...
{
    /// <summary>
    /// Wrapper class extending the HPMaskedTextBox class. It has hooks to change the look and feel
    /// when the look and feel of the framework is changed.
    /// </summary>
    [DefaultPropertyAttribute("Text")]
    [ToolboxBitmapAttribute(typeof(MaskedTextBox))]
    public  class TrafodionMaskedTextBox : MaskedTextBox  
    {
