...
{
  /// <summary>
  /// Wrapper class extending the CheckedListBox class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(CheckedListBox))]
    public class TrafodionCheckedListBox : CheckedListBox  
   {
      ...
      /// Constructor
      /// </summary>
      public TrafodionCheckedListBox()
          : base()
      {
