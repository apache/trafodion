...
{
  /// <summary>
  /// Wrapper class extending the HPFilePreview class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>

    [DefaultPropertyAttribute("CurrentDirectory")]
    [ToolboxBitmapAttribute(typeof(FilePreview))]
    public  class TrafodionFilePreview : FilePreview  
    {
