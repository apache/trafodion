...
{
  /// <summary>
  /// Wrapper class extending the HPReferenceHelp class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(ReferenceHelp))]
    public class TrafodionReferenceHelp : ReferenceHelp  
   {
