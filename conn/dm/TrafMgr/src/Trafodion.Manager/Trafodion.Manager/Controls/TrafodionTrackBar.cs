...
{
  /// <summary>
  /// Wrapper class extending the HPTrackBar class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(TrackBar))]
    public class TrafodionTrackBar : TrackBar  
   {
