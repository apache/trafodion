...
{
  /// <summary>
  /// Wrapper class extending the PictureBox class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
    [ToolboxBitmapAttribute(typeof(PictureBox))]
    public class TrafodionPictureBox : PictureBox  
   {
