...
{
  /// <summary>
  /// Wrapper class extending the HPDataGridTreeColumn class. It has hooks to change the look and feel
  /// when the look and feel of the framework is changed.
  /// </summary>
  public  class TrafodionDataGridTreeColumn : DataGridTreeColumn  
   {
      ...
      /// Constructor
      /// </summary>
      public TrafodionDataGridTreeColumn()
          : base()
      {
