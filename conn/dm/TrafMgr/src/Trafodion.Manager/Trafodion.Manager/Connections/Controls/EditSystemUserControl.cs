...
{
    public partial class EditSystemUserControl : UserControl
    {
        private ConnectionDefinition theConnectionDefinition;

        public EditSystemUserControl(ConnectionDefinition aConnectionDefinition)
        {
            theConnectionDefinition = aConnectionDefinition;
            InitializeComponent();
        }

        private void TheEditSystemButtonClick(object sender, EventArgs e)
        {
