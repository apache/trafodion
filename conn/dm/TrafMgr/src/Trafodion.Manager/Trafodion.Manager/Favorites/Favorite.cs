...
namespace Trafodion.Manager.Framework.Favorites
{
    ...
    /// 
    [Serializable()]
    public class Favorite : FavoritesTreeNode
	{
        ...
        public Favorite(NavigationTreeView aNavigationTreeView, string aName, string aTargetFullPath, string imageKey, string aSystemName)
        {
        ...
        public Favorite(NavigationTreeView aNavigationTreeView, NavigationTreeNode aNavigationTreeNode)
        {
            theNavigationTreeView = aNavigationTreeView;
            theNavigationTreeNodeFullPath = aNavigationTreeNode.FullPath;
            Text = NavigationTreeNode.Text;
            ImageKey = NavigationTreeNode.FavoritesImageKey;
            SelectedImageKey = NavigationTreeNode.FavoritesImageKey;
            systemName = aNavigationTreeNode.TheConnectionDefinition.Name;
            ToolTipText = NavigationTreeNodeFullPath;
        }
        ...
        /// </summary>
        public NavigationTreeNode NavigationTreeNode
		{
			get
			{
                ...
                try
                {
                    ...
                    if (theTreeNode is NavigationTreeNode)
                    {
                        return (theTreeNode as NavigationTreeNode);
                    }
    ...
    public class CannotResolveFavorite : Exception
    {
        ...
        private Favorite _theFavorite;

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="aFavorite">The favorite to which this exception refers</param>
        public CannotResolveFavorite(Favorite aFavorite)
        {
