...
{
    /// <summary>
    /// Represents the execution rules folder in the navigation tree
    /// </summary>
    public class ExecRulesFolder : RulesSubFolder
    {
        #region Properties

        public override string RuleType
        {
            get { return WmsCommand.EXEC_RULE_TYPE; }
        }
        public override List<WmsRule> WmsRuleList
        {
            get { return WmsSystem.WmsExecutionRules; }
        }

        #endregion Properties

        /// <summary>
        /// Default constructor for the execution rules folder
        /// </summary>
        /// <param name="aWmsSystem"></param>
        public ExecRulesFolder(WmsSystem aWmsSystem)
            :base(aWmsSystem)
        {
            Text = Properties.Resources.ExecutionRules;
        }
        ...
        override public string ShortDescription
        {
            get
            {
                return Properties.Resources.ExecutionRules;
            }
        }
