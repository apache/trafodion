...
{
    /// <summary>
    /// Represents the compilation rules folder in the navigation tree
    /// </summary>
    public class CompRulesFolder : RulesSubFolder
    {
        ...
        {
            get { return WmsCommand.COMP_RULE_TYPE; }
        }
        public override List<WmsRule> WmsRuleList
        {
            get { return WmsSystem.WmsCompilationRules; }
        }
        ...
        public CompRulesFolder(WmsSystem aWmsSystem)
            :base(aWmsSystem)
        {
            Text = Properties.Resources.CompilationRules;
        }
        ...
        override public string ShortDescription
        {
            get
            {
                return Properties.Resources.CompilationRules;
            }
        }
