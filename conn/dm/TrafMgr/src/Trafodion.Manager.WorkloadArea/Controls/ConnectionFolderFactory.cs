...
namespace Trafodion.Manager.WorkloadArea.Controls
{
    ...
    class ConnectionFolderFactory : NavigationTreeConnectionFolderFactory
    {
        ...
        {
            return new Trafodion.Manager.WorkloadArea.Controls.Tree.SystemFolder(Trafodion.Manager.WorkloadArea.Model.WmsSystem.FindWmsSystem(aConnectionDefinition));
        }
