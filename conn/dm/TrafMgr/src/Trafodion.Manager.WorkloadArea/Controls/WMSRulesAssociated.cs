...
{
    public partial class WMSRulesAssociated : Trafodion.Manager.Framework.Controls.TrafodionForm
    {
        #region Members
        ...
        public WMSRulesAssociated(WMSWorkloadCanvas parent, ConnectionDefinition cd, string serviceName)
        {
            InitializeComponent();
            m_parent = parent;
            m_cd = cd;
            ...
            //this.ruleAssignedIGrid.SelectionChanged += new EventHandler(iGridRuleAssigned_SelectionChanged);
