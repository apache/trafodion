...
{
    public partial class UserMgmtNavigator : NavigationUserControl
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public UserMgmtNavigator()
            :base ()
        {
            InitializeComponent();

            TheNavigationTreeView = new NavigationTreeView();
        }
        ...
        {
            get { return "UserMgmtPersistence"; }
        }
    }
}
