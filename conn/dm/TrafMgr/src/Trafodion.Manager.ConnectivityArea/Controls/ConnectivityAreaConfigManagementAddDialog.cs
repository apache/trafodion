...
namespace Trafodion.Manager.ConnectivityArea.Controls
{
    ...
    /// </summary>
    public partial class ConnectivityAreaConfigManagementAddDialog : TrafodionForm
    {
        ...
        private NDCSResource _theResource;
        public NDCSResource TheResource
        {
            get { return _theResource; }
            set { _theResource = value; }
        }

        /// <summary>
        /// The Constructor
        /// </summary>
        public ConnectivityAreaConfigManagementAddDialog()
        {
        ...
        public DialogResult Edit(NDCSResource ResourceToEdit)
        {
            ...
            _theConnectivityAreaManagementAddUserControl.EditFrom(ResourceToEdit);

            // Set our title to show what we're doing
            Text = "Edit Management Policy"; //+ objectToEdit.Name;
        ...
        private bool IsWorthy()
        {
            ...
            string theError = _theConnectivityAreaManagementAddUserControl.ValidateInfo();
        ...
        private void TheOKButtonClick(object sender, EventArgs e)
        {
            ...
            this._theResource = this._theConnectivityAreaManagementAddUserControl.GetResourceObject();
