...
{
    public partial class StopDatasourceDialog : TrafodionForm
    {
        #region Fields
        ...
        public string TheReason
        {
            get
            {
                return NDCSName.GetDelimitedName(theReason);
            }
        }
        ...
        /// <param name="theConnectedCount"></param>
        public StopDatasourceDialog(NDCSSystem NdcsSystem, string Title, int theConnectedCount)
        {
            InitializeComponent();
            SetInitialValues(NdcsSystem, Title, theConnectedCount);

            this.DatasourceNameLabel.Text = Properties.Resources.StopDatasourceMessage1;
            this.MessageLabel2.Text = Properties.Resources.StopDatasourceMessage2;
        }
        ...
        /// <param name="Title"></param>
        /// <param name="theConnectedCount"></param>
        public StopDatasourceDialog(NDCSSystem NdcsSystem, string Title, string DatasourceName, int theConnectedCount)
        {
            InitializeComponent();
            SetInitialValues(NdcsSystem, Title, theConnectedCount);
            this.DatasourceNameLabel.Text = DatasourceName;
            this.Monitor_TrafodionToolTip.SetToolTip(this.DatasourceNameLabel, DatasourceName);

            this.MessageLabel2.Text = Properties.Resources.StopDatasourceMessage1;
            this.MessageLabel3.Text = Properties.Resources.StopDatasourceMessage2;

        }

        void SetInitialValues(NDCSSystem NdcsSystem, string Title, int theConnectedCount)
        {
            theSystem = NdcsSystem;
