...
namespace Trafodion.Manager.ConnectivityArea.Controls
{
    ...
    /// </summary>
    public partial class ConnectivityAreaConfigCQDAddDialog : TrafodionForm
    {
        ...
        public Trafodion.Manager.ConnectivityArea.Model.CQD CQD
        {
            get { return _theConnectivityAreaCQDAddUserControl.CQD; }
        }
        ...
        /// The Constructor
        /// </summary>
        public ConnectivityAreaConfigCQDAddDialog()
        {
            ...
            _theConnectivityAreaCQDAddUserControl.OKButton = this._theOKButton;
        }
        ...
        public DialogResult Edit(CQD cqdToEdit)
        {
            ...
            _theConnectivityAreaCQDAddUserControl.EditFrom(cqdToEdit);

            // Set our title to show what we're doing
            Text = "Editing CQD"; //+ objectToEdit.Name;
        ...
        private bool IsWorthy()
        {
            ...
            string theError = _theConnectivityAreaCQDAddUserControl.ValidateInfo();
