...
{
    /// <summary>
    /// Data provider for the Alerts widget
    /// </summary>
    public class AlertsDataProvider : DatabaseDataProvider
    {
        ...
        private const string PROBLEM_MGMT_TABLE = "MANAGEABILITY.INSTANCE_REPOSITORY.PROBLEM_INSTANCE_TABLE";
        private const string PROBLEM_MGMT_VIEW = "MANAGEABILITY.INSTANCE_REPOSITORY.PROBLEM_INSTANCE_1";
        private const string PROBLEM_MGMT_UPDATE_PROCEDURE = "TRAFODION.SP.UPDATE_PROBLEM";
        ...
        public override void DoFetchData(Trafodion.Manager.Framework.WorkerThread worker, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (IsValidationRun)
            {
                ...
                if (ViewExists)
                {
                    UserCanView = CanUserView(dbConfig.ConnectionDefinition);
                    if (UserCanView)
                    {
        ...
        /// <returns>True or False</returns>
        public static bool CanUserView(ConnectionDefinition aConnectionDefinition)
        {
            ...
            try
            {
                ...
                string[] nameParts = Utilities.CrackSQLAnsiName(PROBLEM_MGMT_VIEW);
