...
{
    public partial class AlarmsNotesEditor : TrafodionForm
    {
        ...
        public AlarmsNotesEditor(ConnectionDefinition aConnectionDefinition, string existingNotes)
        {
            InitializeComponent();
        ...
        {
            TrafodionHelpProvider.Instance.ShowHelpTopic(HelpTopics.UpdateNotesDialog);
        }
    }
}
