...
{
    public partial class SampledStatsGraphControl : UserControl
    {
        Chart _theChart = new Chart();

        public SampledStatsGraphControl()
        {
            InitializeComponent();
        ...
        private Series GetSeries()
        {
            ...
            series.Legend = Properties.Resources.SampledCardinality;
        ...
        {
            _theChart.ChartAreas["Default"].AxisX.Title = Properties.Resources.IntervalNumber;
            _theChart.ChartAreas["Default"].AxisY.Title = Properties.Resources.SampledCardinality;
