...
namespace Trafodion.Manager.DatabaseArea.Controls
{
    ...
    /// <summary>
    /// A TabPage that displays a Library's usage.
    /// </summary>
    public class LibraryUsageTabPage : DelayedPopulateClonableTabPage
    {
        ...
        /// <summary>
        /// The Library's property.  Changing it to a new value will not have an effect
        /// until the Refresh() method is called.  We don't call it directly because we want this page to be delayed.
        /// </summary>
        ...
        /// <summary>
        /// Create a TabPage that displays a Library's usage.
        /// </summary>
        ...
        /// <param name="aTrafodionMaterializedView">The Library whose usage is to be displayed.</param>
        public LibraryUsageTabPage(DatabaseObjectsControl aDatabaseObjectsControl, TrafodionLibrary aTrafodionLibrary)
        ...
        {
            object a = _sqlMxLibrary.TheUsedByTrafodionRoutines;
        }
        /// <summary>
        /// Constructs a panel for displaying the usage information for this Library
        /// </summary>
        override protected void Populate()
        {
            ...
            LibraryUsagePanel libraryUsagePanel = new LibraryUsagePanel(TheDatabaseObjectsControl, TrafodionLibrary);
            libraryUsagePanel.Dock = DockStyle.Fill;
            Controls.Add(libraryUsagePanel);
        }
