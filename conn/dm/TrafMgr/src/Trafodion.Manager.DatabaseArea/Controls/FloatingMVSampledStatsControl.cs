...
{
    public partial class FloatingMVSampledStatsControl : UserControl, IMenuProvider
    {
        private MVSampledStatsSummaryControl _sampledStatsSummaryControl;
        private MVSampledStatsFreqValuesControl _sampledStatsFreqValuesControl;
        private MVSampledStatsIntervalControl _sampledStatsIntervalControl;
        private SampledStatsGraphControl _sampledStatsGraphControl;
        private System.Drawing.Size _theCurrentSize;
        private TrafodionMaterializedViewColumn _sqlMxMaterializedViewColumn = null;
        private static readonly string MVStatsPersistenceKey = "MVStatistics";
        private System.ComponentModel.BackgroundWorker _backgroundWorker;

        /// <summary>
        /// Constructs the user control to display the statistics for the materialized column
        /// </summary>
        /// <param name="sqlMxMaterializedViewColumn">The SQL materialized view column model</param>
        public FloatingMVSampledStatsControl(TrafodionMaterializedViewColumn sqlMxMaterializedViewColumn)
        {
            InitializeComponent();
            _sqlMxMaterializedViewColumn = sqlMxMaterializedViewColumn;
            widgetCanvas.ThePersistenceKey = MVStatsPersistenceKey;
            ...
            _sampledStatsSummaryControl = new MVSampledStatsSummaryControl();
            ...
            _sampledStatsFreqValuesControl = new MVSampledStatsFreqValuesControl();
            ...
            _sampledStatsIntervalControl = new MVSampledStatsIntervalControl();
            ...
            this.Enter += new System.EventHandler(MVSampledStatsControl_Enter);
            ...
            LockManager.LockHandlers += new LockManager.LockHandler(MVFloatingSampledStatsControl_Lock);
        ...
        /// </summary>
        private void MVFloatingSampledStatsControl_Resize(object sender, EventArgs e)
        {
        ...
        /// </summary>
        private void MVFloatingSampledStatsControl_Lock(LockManager.LockOperation aLockOperation)
        {
        ...
        /// <param name="e"></param>
        private void MVSampledStatsControl_Enter(object sender, EventArgs e)
        {
            try
            {
                _sqlMxMaterializedViewColumn.SampledStatistics = null;//reset the earlier sample
                InitializeBackgoundWorker();
                _sampledStatsSummaryControl.InitializeControl(_sqlMxMaterializedViewColumn);
                _sampledStatsFreqValuesControl.InitializeControl();
                _sampledStatsIntervalControl.InitializeControl();
                Cursor = Cursors.WaitCursor;
                _backgroundWorker.RunWorkerAsync(_sqlMxMaterializedViewColumn);
            }
            catch (Exception ex)
            {
                string header = String.Format(Properties.Resources.ErrorWhileSampling, _sqlMxMaterializedViewColumn.TrafodionSchemaObject.VisibleAnsiName);
            ...
            DoWorkEventArgs e)
        {
            ...
            RunSample((TrafodionMaterializedViewColumn)e.Argument, worker, e);
        }
            ...
            object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            {
                TrafodionMaterializedViewColumn sqlMxMaterializedViewColumn = e.Result as TrafodionMaterializedViewColumn;
                if (sqlMxMaterializedViewColumn != null)
                {
                    _sampledStatsSummaryControl.Populate(sqlMxMaterializedViewColumn);
                    _sampledStatsFreqValuesControl.Populate(sqlMxMaterializedViewColumn);
                    _sampledStatsIntervalControl.Populate(sqlMxMaterializedViewColumn);
        ...
        void RunSample(TrafodionMaterializedViewColumn sqlMxMaterializedViewColumn, BackgroundWorker worker, DoWorkEventArgs e)
        {
            ...
            {
                int count = sqlMxMaterializedViewColumn.SampledStatistics.FrequentValues.Count;
                if (worker.CancellationPending)
                {
                    e.Cancel = true;
                    return;
                ...
                count = sqlMxMaterializedViewColumn.SampledStatistics.SampledIntervals.Count;
                if (worker.CancellationPending)
                {
                    e.Cancel = true;
                }
                e.Result = sqlMxMaterializedViewColumn;
            }
        }
