...
{
    public partial class SampledStatsFreqValuesControl : UserControl
    {
        public SampledStatsFreqValuesControl()
        {
            InitializeComponent();
        ...
        {
            List<TableColumnSampledStats.FrequentValue> frequentValues = sqlMxTableColumn.SampledStatistics.FrequentValues;
            if (frequentValues != null)
            {
                foreach (TableColumnSampledStats.FrequentValue frequentValue in frequentValues)
                {
