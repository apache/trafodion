...
namespace Trafodion.Manager.DatabaseArea.Controls.Tree
{
    ...
    /// </summary>
    abstract public class SchemaItemsFolder : DatabaseTreeFolder, IHasTrafodionSchema
    {
        public SchemaItemsFolder(string aText, TrafodionSchema aTrafodionSchema)
            :base(aTrafodionSchema, true)
        {
            Text = aText;
        }
        ...
        override public string ShortDescription
        {
            get
            {
                return Text + " in " + TheTrafodionSchema.ExternalName;
            }
        }
        ...
        override public string LongerDescription
        {
            get
            {
                return Text + " in Schema " + TheTrafodionSchema.VisibleAnsiName;
            }
        }
