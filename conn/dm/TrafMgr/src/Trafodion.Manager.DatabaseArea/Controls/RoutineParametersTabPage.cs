...
{
    class RoutineParametersTabPage : DelayedPopulateClonableTabPage
    {
        ...
        public RoutineParametersTabPage(TrafodionRoutine aTrafodionRoutine)
        ...
        override protected void Populate()
        {
            ...
            RoutineParametersPanel routineParametersPanel = new RoutineParametersPanel(TrafodionRoutine);
            routineParametersPanel.Dock = DockStyle.Fill;
            Controls.Add(routineParametersPanel);
        }
