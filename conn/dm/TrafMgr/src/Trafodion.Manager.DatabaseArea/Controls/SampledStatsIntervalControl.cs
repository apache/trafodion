...
{
    public partial class SampledStatsIntervalControl : UserControl
    {
        public SampledStatsIntervalControl()
        {
            InitializeComponent();
        ...
        public void Populate(TrafodionTableColumn sqlMxTableColumn)
        {
            ...
            List<TableColumnSampledStats.SampledInterval> sampledIntervals = sqlMxTableColumn.SampledStatistics.SampledIntervals;
