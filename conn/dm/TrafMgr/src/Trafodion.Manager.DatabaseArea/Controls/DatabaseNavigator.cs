...
{
    public partial class DatabaseNavigator : NavigationUserControl
    {
        /// <summary>
        /// Constructor
        /// </summary>
            ...
            :base ()
        {
            ...
            TheNavigationTreeView = new DatabaseTreeView();
        }
        ...
        {
            get { return "DatabaseAreaPersistence"; }
        }

        public DatabaseTreeView DatabaseTreeView
        {
           get { return TheNavigationTreeView as DatabaseTreeView;}
        }
    }
}
