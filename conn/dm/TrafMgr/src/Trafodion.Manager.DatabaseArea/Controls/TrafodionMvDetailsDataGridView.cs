...
{
    /// <summary>
    /// A generic datagridview to display the details for a list of MVs.
    /// </summary>
    public class SqlMxMvDetailsDataGridView :SqlMxSchemaObjectDetailsDataGridView 
    {

        /// <summary>
        /// Default constructor for the UI designer
        /// </summary>
        public SqlMxMvDetailsDataGridView()
            : base()
        {
        }
        ...
        public SqlMxMvDetailsDataGridView(DatabaseObjectDetailsControl aDatabaseObjectDetailsControl,
        ...
        {
            TheDataTable = TheSqlMxSchemaObjectsSummary.getMVsSummary();
