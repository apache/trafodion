...
namespace Trafodion.Manager.DatabaseArea.Controls
{
    ...
    /// </summary>
    public class TablesSpaceUsageSummaryTabPage : DelayedPopulateTabPage, IHasTrafodionSchema
    {
        ...
        public TablesSpaceUsageSummaryTabPage(DatabaseObjectsControl aDatabaseObjectsControl, TrafodionSchema schema)
        ...
        {
            this.Controls.Clear();
            TablesSpaceUsageSummaryControl tablesSummarySpaceControl = new TablesSpaceUsageSummaryControl(_databaseObjectsControl, _schema);
            tablesSummarySpaceControl.Dock = DockStyle.Fill;
            this.Controls.Add(tablesSummarySpaceControl);
        }
    }
}
