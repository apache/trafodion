...
namespace Trafodion.Manager.DatabaseArea.Controls
{
    ...
    /// </summary>
    public class MVsSpaceUsageSummaryTabPage : DelayedPopulateTabPage, IHasTrafodionSchema
    {
        ...
        public MVsSpaceUsageSummaryTabPage(DatabaseObjectsControl aDatabaseObjectsControl, TrafodionSchema schema)
        ...
        {
            this.Controls.Clear();
            MVsSpaceUsageSummaryControl mvSummarySpaceControl = new MVsSpaceUsageSummaryControl(_databaseObjectsControl, _schema);
            mvSummarySpaceControl.Dock = DockStyle.Fill;
            this.Controls.Add(mvSummarySpaceControl);
        }
    }
}
