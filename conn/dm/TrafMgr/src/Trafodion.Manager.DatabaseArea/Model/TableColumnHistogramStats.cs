...
{
    /// <summary>
    /// A model object that holds the histogram statistics for the table column
    /// </summary>
    public class TableColumnHistogramStats : TableColumnStats
    {
        #region Fields
        ...
        public TableColumnHistogramStats(TrafodionTableColumn aTrafodionTableColumn)
        ...
        public void SetAttributes(OdbcDataReader odbcDataReader)
        {
            ...
            if (_sqlMxTableColumn.TrafodionTable.TheTrafodionSchema.Version >= 2300)
            {
