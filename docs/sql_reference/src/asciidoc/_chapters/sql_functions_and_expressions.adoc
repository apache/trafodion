...
| <<buffertolob_function,BUFFERTOLOB_Function>>     | Takes an address and a size of an input buffer, and converts the data pointed to by that buffer into LOB format.
...
The BUFFERTOLOB function takes an address and a size of an input buffer, and converts the data pointed to by that buffer into LOB. This function can be used in INSERT or UPDATE statement.
...
This function can be used in INSERT or UPDATE statement, to initialize a LOB column or attribute to EMPTY.
...
The EXTERNALTOLOB function converts data from an external file into LOB format. This function can be used in INSERT or UPDATE statement.          
