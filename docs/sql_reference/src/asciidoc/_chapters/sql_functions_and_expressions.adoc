...
The PIVOT function transposes rows of a table into a column.
...
+
```
SELECT PIVOT(vendor_id), PIVOT(vendor_email) FROM vendor;

(EXPR)                   (EXPR)                                                                                                                          
------------------------ --------------------------------------------------
111,232,367              tom@hotmail.com,jerry@hotmail.com,aven@hotmail.com   
...
+
```
SELECT PIVOT(vendor_email, delimiter ' ') FROM vendor;

(EXPR)
--------------------------------------------------
tom@hotmail.com jerry@hotmail.com aven@hotmail.com                                                                          
