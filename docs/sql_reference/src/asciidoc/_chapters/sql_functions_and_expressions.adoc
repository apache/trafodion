...
validation of the IP address. The _expression_ cannot contain an aggregate
function or a subquery. All nulls are eliminated before the function is
applied to the set of values. If the result table is empty, IS_IPV6 
returns NULL.
See <<expressions,Expressions>>.
...
function or a subquery. All nulls are eliminated before the function 
is applied to the set of values. If the result table is empty,
INET_ATON returns NULL.
See <<expressions,Expressions>>.
...
an aggregate function or a subquery. All nulls are eliminated before the function
is applied to the set of values. If the result table is empty, INET_NTOA 
returns NULL.
See <<expressions,Expressions>>.
