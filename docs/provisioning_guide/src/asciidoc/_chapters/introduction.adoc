...
Thsi guide assumes that a Hadoop environment exists upon which your provisioning Trafodion. Refer to
...
you use the Trafodion Installer for initial installation and upgrades of Trafodion. These steaps are refered to as
...
2. *Expert Install*: Required information is provided in a pre-formatted bash-script configuration file, which is provided
...
+
Expert Install is recommended for the expert user and/or for unattended installs.
Refer to <<introduction-trafodion-expert-setup,Expert Setup>> for information about how to
populate this file.
...
[[introduction-trafodion-installer-expert-setup]]
=== Expert Setup
...
* <<install-expert-install, Expert Install>>
* <<upgrade-expert-upgrade, Expert Upgrade>>
