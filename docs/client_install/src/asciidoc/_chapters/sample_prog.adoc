...
Copy and paste the following code into a file named `basicsql.cpp`:
...
Copy and paste the following code into a file named `build.bat`, which is used to build the sample program on Windows:
...
Copy and paste the following code into a file named `run.bat`, which is used to run the sample program on Windows:
