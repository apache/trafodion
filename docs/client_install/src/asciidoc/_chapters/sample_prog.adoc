...
http://trafodion.incubator.apache.org/docs/latest/client_install/resources/source/basicsql.cpp.
...
http://trafodion.incubator.apache.org/docs/latest/client_install/resources/source/build.bat.
...
http://trafodion.incubator.apache.org/docs/latest/client_install/resources/source/run.bat.
