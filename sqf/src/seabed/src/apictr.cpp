...
static const char *ga_sb_api_ctr_names[] = {
        ...
        "BMSG_AGGR_GET_FREE_",
        "BMSG_AGGR_GET_INIT_",
        "BMSG_AGGR_GET_LINKCTRL_",
        "BMSG_AGGR_GET_LINKDATA_",
        "BMSG_AGGR_GET_READCTRL_",
        "BMSG_AGGR_GET_READDATA_",
        "BMSG_AGGR_LINK_",
        "BMSG_AGGR_PUT_FREE_",
        "BMSG_AGGR_PUT_INIT_",
        "BMSG_AGGR_PUT_LINK_AG2AG_",
        "BMSG_AGGR_PUT_LINK_AG2IND_",
        "BMSG_AGGR_PUT_REPLY_AG2AG_",
        "BMSG_AGGR_PUT_REPLY_AG2IND_",
        "BMSG_AGGR_PUT_RESET_",
        "BMSG_AGGR_PUT_SIZE_",
        "BMSG_AGGR_REPLY_AG2AG_",
        "BMSG_AGGR_REPLY_AG2IND_",
        "BMSG_AWAIT_",
        "BMSG_BREAK_",
        "BMSG_GETREQINFO_",
        "BMSG_HOLD_",
