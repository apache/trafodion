...
namespace SB_API {
    ...
    typedef enum Ctr_Type {
        ...
        SB_ACTR_BMSG_AGGR_GET_FREE_,
        SB_ACTR_BMSG_AGGR_GET_INIT_,
        SB_ACTR_BMSG_AGGR_GET_LINKCTRL_,
        SB_ACTR_BMSG_AGGR_GET_LINKDATA_,
        SB_ACTR_BMSG_AGGR_GET_READCTRL_,
        SB_ACTR_BMSG_AGGR_GET_READDATA_,
        SB_ACTR_BMSG_AGGR_LINK_,
        SB_ACTR_BMSG_AGGR_PUT_FREE_,
        SB_ACTR_BMSG_AGGR_PUT_INIT_,
        SB_ACTR_BMSG_AGGR_PUT_LINK_AG2AG_,
        SB_ACTR_BMSG_AGGR_PUT_LINK_AG2IND_,
        SB_ACTR_BMSG_AGGR_PUT_REPLY_AG2AG_,
        SB_ACTR_BMSG_AGGR_PUT_REPLY_AG2IND_,
        SB_ACTR_BMSG_AGGR_PUT_RESET_,
        SB_ACTR_BMSG_AGGR_PUT_SIZE_,
        SB_ACTR_BMSG_AGGR_REPLY_AG2AG_,
        SB_ACTR_BMSG_AGGR_REPLY_AG2IND_,
        SB_ACTR_BMSG_AWAIT_,
        SB_ACTR_BMSG_BREAK_,
