...
enum {
    ERR_C1 = 0, // client-1st call
    ERR_S1 = 1, // server-1st call
    ERR_S2 = 2, // server-2nd call
    ERR_C2 = 3  // client-2nd call
};
