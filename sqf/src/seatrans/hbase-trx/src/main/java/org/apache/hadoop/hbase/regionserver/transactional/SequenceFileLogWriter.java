...
public class SequenceFileLogWriter implements HLog.Writer {
   ...
   */
  private org.apache.hadoop.hbase.regionserver.transactional.CompressionContext compressionContext;
  ...
  throws IOException {
    ...
    if (compress) {
      try {
        if (this.compressionContext == null) {
          ...
          this.compressionContext = new CompressionContext((Class<? extends Dictionary>) LRUDictionary.class);
        } else {
    ...
    try {
      ...
      this.writer = (SequenceFile.Writer) SequenceFile.class
        ...
        .invoke(null, new Object[] {fs, conf, path, keyClass,
            WALEdit.class,
  ...
  public void sync() throws IOException {
    if (this.syncFs != null) {
      try {
       this.syncFs.invoke(this.writer, new Object []{});
      } catch (Exception e) {
        throw new IOException("Reflection", e);
      }
    } else if (this.hflush != null) {
      try {
        this.hflush.invoke(getWriterFSDataOutputStream(), new Object []{});
      } catch (Exception e) {
        throw new IOException("Reflection", e);
      }
    }
