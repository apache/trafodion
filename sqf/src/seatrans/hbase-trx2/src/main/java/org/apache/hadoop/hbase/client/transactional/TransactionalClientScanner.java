...
/*
public class TransactionalClientScanner extends ClientScanner {

    private TransactionState transactionState;
    protected TransactionalClientScanner(final TransactionState transactionState, final Configuration conf, final Scan scan,
    		HConnection connection, final byte[] tableName) throws IOException {
    	
    	super(conf, scan, tableName, connection, false);    	
        this.transactionState = transactionState;
        
    }         
    
    @Override
    protected ScannerCallable getScannerCallable(final byte[] localStartKey, final int nbRows) {
        getScan().setStartRow(localStartKey);                
        TransactionScannerCallable t = new TransactionScannerCallable(this.transactionState, getConnection(),
 ...
 * through them all.
 */
public class TransactionalClientScanner extends AbstractClientScanner implements ResultScanner {
     ...
     * @throws IOException
     */
    public TransactionalClientScanner(final TransactionState transactionState,
    		final Configuration conf, final Scan scan,
  	      final byte[] tableName, HConnection connection) throws IOException {
  	this(conf, scan, tableName, connection, false);
    this.transactionState = transactionState;
  }
     ...
     * @throws IOException
     */
    public TransactionalClientScanner(final Configuration conf, final Scan scan,
    ...
    public TransactionalClientScanner(final Configuration conf, final Scan scan,
      final byte[] tableName, HConnection connection, final boolean init) throws IOException {
          ...
          try {
            ...
            if (e instanceof UnknownScannerException) {
              ...
              if (timeout < System.currentTimeMillis()) {
                ...
                /*
                //  Commenting out, Issue with ScannerTimeoutException constructor
