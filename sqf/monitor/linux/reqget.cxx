...
void CExtGetReq::populateRequestString( void )
{
    ...
    snprintf( strBuf, sizeof(strBuf), 
              ...
              msg_->u.request.u.get.group, msg_->u.request.u.get.key );
...
void CExtGetReq::performRequest()
{
    ...
    {
        trace_printf("%s@%d request #%ld: Get, type=%d, group=%s, key=%s, "
                     "next=%d\n", method_name, __LINE__, id_,
                     msg_->u.request.u.get.type, msg_->u.request.u.get.group,
                     msg_->u.request.u.get.key,  msg_->u.request.u.get.next);
    }
